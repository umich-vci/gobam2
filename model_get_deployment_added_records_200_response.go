...
// checks if the GetDeploymentAddedRecords200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeploymentAddedRecords200Response{}

// GetDeploymentAddedRecords200Response struct for GetDeploymentAddedRecords200Response
type GetDeploymentAddedRecords200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDeploymentAddedRecords200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDeploymentAddedRecords200Response() *GetDeploymentAddedRecords200Response {
	this := GetDeploymentAddedRecords200Response{}
	return &this
}
...
func (o *GetDeploymentAddedRecords200Response) GetData() []GetDeploymentAddedRecords200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDeploymentAddedRecords200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDeploymentAddedRecords200ResponseDataInner and assigns it to the Data field.
func (o *GetDeploymentAddedRecords200Response) SetData(v []GetDeploymentAddedRecords200ResponseDataInner) {
	o.Data = v
}

func (o GetDeploymentAddedRecords200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDeploymentAddedRecords200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeploymentAddedRecords200Response struct {
	value *GetDeploymentAddedRecords200Response
	isSet bool
}

func (v NullableGetDeploymentAddedRecords200Response) Get() *GetDeploymentAddedRecords200Response {
	return v.value
}

func (v *NullableGetDeploymentAddedRecords200Response) Set(val *GetDeploymentAddedRecords200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeploymentAddedRecords200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeploymentAddedRecords200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeploymentAddedRecords200Response(val *GetDeploymentAddedRecords200Response) *NullableGetDeploymentAddedRecords200Response {
	return &NullableGetDeploymentAddedRecords200Response{value: val, isSet: true}
}

func (v NullableGetDeploymentAddedRecords200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeploymentAddedRecords200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
