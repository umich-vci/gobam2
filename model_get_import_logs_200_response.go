...
// checks if the GetImportLogs200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetImportLogs200Response{}

// GetImportLogs200Response struct for GetImportLogs200Response
type GetImportLogs200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetImportLogs200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetImportLogs200Response) GetData() []GetImportLogs200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetImportLogs200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetImportLogs200ResponseDataInner and assigns it to the Data field.
func (o *GetImportLogs200Response) SetData(v []GetImportLogs200ResponseDataInner) {
	o.Data = v
}

func (o GetImportLogs200Response) MarshalJSON() ([]byte, error) {
...
func (o GetImportLogs200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetImportLogs200Response struct {
	value *GetImportLogs200Response
	isSet bool
}

func (v NullableGetImportLogs200Response) Get() *GetImportLogs200Response {
	return v.value
}

func (v *NullableGetImportLogs200Response) Set(val *GetImportLogs200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetImportLogs200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetImportLogs200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetImportLogs200Response(val *GetImportLogs200Response) *NullableGetImportLogs200Response {
	return &NullableGetImportLogs200Response{value: val, isSet: true}
}

func (v NullableGetImportLogs200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetImportLogs200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
