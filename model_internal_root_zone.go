...
// checks if the InternalRootZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalRootZone{}

// InternalRootZone struct for InternalRootZone
...
func (o InternalRootZone) MarshalJSON() ([]byte, error) {
...
func (o InternalRootZone) ToMap() (map[string]interface{}, error) {
...
type NullableInternalRootZone struct {
	value *InternalRootZone
	isSet bool
}

func (v NullableInternalRootZone) Get() *InternalRootZone {
	return v.value
}

func (v *NullableInternalRootZone) Set(val *InternalRootZone) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalRootZone) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalRootZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalRootZone(val *InternalRootZone) *NullableInternalRootZone {
	return &NullableInternalRootZone{value: val, isSet: true}
}

func (v NullableInternalRootZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalRootZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
