...
// checks if the GetNamingPolicyRestrictions200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNamingPolicyRestrictions200ResponseDataInner{}

// GetNamingPolicyRestrictions200ResponseDataInner struct for GetNamingPolicyRestrictions200ResponseDataInner
type GetNamingPolicyRestrictions200ResponseDataInner struct {
	...
	Restrictions []ValueMatchTypePairBean `json:"restrictions,omitempty"`
...
func NewGetNamingPolicyRestrictions200ResponseDataInner() *GetNamingPolicyRestrictions200ResponseDataInner {
	this := GetNamingPolicyRestrictions200ResponseDataInner{}
	return &this
}
...
// SetRestrictions gets a reference to the given []ValueMatchTypePairBean and assigns it to the Restrictions field.
...
func (o GetNamingPolicyRestrictions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetNamingPolicyRestrictions200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetNamingPolicyRestrictions200ResponseDataInner struct {
	value *GetNamingPolicyRestrictions200ResponseDataInner
	isSet bool
}

func (v NullableGetNamingPolicyRestrictions200ResponseDataInner) Get() *GetNamingPolicyRestrictions200ResponseDataInner {
	return v.value
}

func (v *NullableGetNamingPolicyRestrictions200ResponseDataInner) Set(val *GetNamingPolicyRestrictions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNamingPolicyRestrictions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNamingPolicyRestrictions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNamingPolicyRestrictions200ResponseDataInner(val *GetNamingPolicyRestrictions200ResponseDataInner) *NullableGetNamingPolicyRestrictions200ResponseDataInner {
	return &NullableGetNamingPolicyRestrictions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetNamingPolicyRestrictions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNamingPolicyRestrictions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
