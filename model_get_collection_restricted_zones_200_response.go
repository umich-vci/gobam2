...
// checks if the GetCollectionRestrictedZones200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionRestrictedZones200Response{}

// GetCollectionRestrictedZones200Response struct for GetCollectionRestrictedZones200Response
type GetCollectionRestrictedZones200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionRestrictedZones200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionRestrictedZones200Response() *GetCollectionRestrictedZones200Response {
	this := GetCollectionRestrictedZones200Response{}
	return &this
}
...
func (o *GetCollectionRestrictedZones200Response) GetData() []GetCollectionRestrictedZones200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionRestrictedZones200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionRestrictedZones200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionRestrictedZones200Response) SetData(v []GetCollectionRestrictedZones200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionRestrictedZones200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionRestrictedZones200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionRestrictedZones200Response struct {
	value *GetCollectionRestrictedZones200Response
	isSet bool
}

func (v NullableGetCollectionRestrictedZones200Response) Get() *GetCollectionRestrictedZones200Response {
	return v.value
}

func (v *NullableGetCollectionRestrictedZones200Response) Set(val *GetCollectionRestrictedZones200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionRestrictedZones200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionRestrictedZones200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionRestrictedZones200Response(val *GetCollectionRestrictedZones200Response) *NullableGetCollectionRestrictedZones200Response {
	return &NullableGetCollectionRestrictedZones200Response{value: val, isSet: true}
}

func (v NullableGetCollectionRestrictedZones200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionRestrictedZones200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
