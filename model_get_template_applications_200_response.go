...
// checks if the GetTemplateApplications200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTemplateApplications200Response{}

// GetTemplateApplications200Response struct for GetTemplateApplications200Response
type GetTemplateApplications200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetTemplateApplications200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetTemplateApplications200Response() *GetTemplateApplications200Response {
	this := GetTemplateApplications200Response{}
	return &this
}
...
func (o *GetTemplateApplications200Response) GetData() []GetTemplateApplications200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTemplateApplications200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTemplateApplications200ResponseDataInner and assigns it to the Data field.
func (o *GetTemplateApplications200Response) SetData(v []GetTemplateApplications200ResponseDataInner) {
	o.Data = v
}

func (o GetTemplateApplications200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTemplateApplications200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTemplateApplications200Response struct {
	value *GetTemplateApplications200Response
	isSet bool
}

func (v NullableGetTemplateApplications200Response) Get() *GetTemplateApplications200Response {
	return v.value
}

func (v *NullableGetTemplateApplications200Response) Set(val *GetTemplateApplications200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTemplateApplications200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTemplateApplications200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTemplateApplications200Response(val *GetTemplateApplications200Response) *NullableGetTemplateApplications200Response {
	return &NullableGetTemplateApplications200Response{value: val, isSet: true}
}

func (v NullableGetTemplateApplications200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTemplateApplications200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
