...
// checks if the GetTrustRelationships200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTrustRelationships200Response{}

// GetTrustRelationships200Response struct for GetTrustRelationships200Response
type GetTrustRelationships200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetTrustRelationships200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetTrustRelationships200Response() *GetTrustRelationships200Response {
	this := GetTrustRelationships200Response{}
	return &this
}
...
func (o *GetTrustRelationships200Response) GetData() []GetTrustRelationships200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTrustRelationships200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTrustRelationships200ResponseDataInner and assigns it to the Data field.
func (o *GetTrustRelationships200Response) SetData(v []GetTrustRelationships200ResponseDataInner) {
	o.Data = v
}

func (o GetTrustRelationships200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTrustRelationships200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTrustRelationships200Response struct {
	value *GetTrustRelationships200Response
	isSet bool
}

func (v NullableGetTrustRelationships200Response) Get() *GetTrustRelationships200Response {
	return v.value
}

func (v *NullableGetTrustRelationships200Response) Set(val *GetTrustRelationships200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTrustRelationships200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTrustRelationships200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTrustRelationships200Response(val *GetTrustRelationships200Response) *NullableGetTrustRelationships200Response {
	return &NullableGetTrustRelationships200Response{value: val, isSet: true}
}

func (v NullableGetTrustRelationships200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTrustRelationships200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
