...
// checks if the GetClientClasses200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetClientClasses200Response{}

// GetClientClasses200Response struct for GetClientClasses200Response
type GetClientClasses200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetClientClasses200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetClientClasses200Response() *GetClientClasses200Response {
	this := GetClientClasses200Response{}
	return &this
}
...
func (o *GetClientClasses200Response) GetData() []GetClientClasses200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetClientClasses200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetClientClasses200ResponseDataInner and assigns it to the Data field.
func (o *GetClientClasses200Response) SetData(v []GetClientClasses200ResponseDataInner) {
	o.Data = v
}

func (o GetClientClasses200Response) MarshalJSON() ([]byte, error) {
...
func (o GetClientClasses200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetClientClasses200Response struct {
	value *GetClientClasses200Response
	isSet bool
}

func (v NullableGetClientClasses200Response) Get() *GetClientClasses200Response {
	return v.value
}

func (v *NullableGetClientClasses200Response) Set(val *GetClientClasses200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetClientClasses200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetClientClasses200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetClientClasses200Response(val *GetClientClasses200Response) *NullableGetClientClasses200Response {
	return &NullableGetClientClasses200Response{value: val, isSet: true}
}

func (v NullableGetClientClasses200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetClientClasses200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
