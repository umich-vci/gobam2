...
// checks if the DNSMove type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DNSMove{}

// DNSMove struct for DNSMove
type DNSMove struct {
	Move
	// The resource type.
...
func (o DNSMove) MarshalJSON() ([]byte, error) {
...
func (o DNSMove) ToMap() (map[string]interface{}, error) {
...
type NullableDNSMove struct {
	value *DNSMove
	isSet bool
}

func (v NullableDNSMove) Get() *DNSMove {
	return v.value
}

func (v *NullableDNSMove) Set(val *DNSMove) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSMove) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSMove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSMove(val *DNSMove) *NullableDNSMove {
	return &NullableDNSMove{value: val, isSet: true}
}

func (v NullableDNSMove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDNSMove) UnmarshalJSON(src []byte) error {
	v.isSet = true
