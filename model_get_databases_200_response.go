...
// checks if the GetDatabases200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDatabases200Response{}

// GetDatabases200Response struct for GetDatabases200Response
type GetDatabases200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDatabases200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetDatabases200Response) GetData() []GetDatabases200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDatabases200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDatabases200ResponseDataInner and assigns it to the Data field.
func (o *GetDatabases200Response) SetData(v []GetDatabases200ResponseDataInner) {
	o.Data = v
}

func (o GetDatabases200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDatabases200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDatabases200Response struct {
	value *GetDatabases200Response
	isSet bool
}

func (v NullableGetDatabases200Response) Get() *GetDatabases200Response {
	return v.value
}

func (v *NullableGetDatabases200Response) Set(val *GetDatabases200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDatabases200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDatabases200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDatabases200Response(val *GetDatabases200Response) *NullableGetDatabases200Response {
	return &NullableGetDatabases200Response{value: val, isSet: true}
}

func (v NullableGetDatabases200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDatabases200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
