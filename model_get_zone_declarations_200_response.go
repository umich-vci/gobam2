...
// checks if the GetZoneDeclarations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneDeclarations200Response{}

// GetZoneDeclarations200Response struct for GetZoneDeclarations200Response
type GetZoneDeclarations200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetZoneDeclarations200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetZoneDeclarations200Response() *GetZoneDeclarations200Response {
	this := GetZoneDeclarations200Response{}
	return &this
}
...
func (o *GetZoneDeclarations200Response) GetData() []GetZoneDeclarations200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetZoneDeclarations200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetZoneDeclarations200ResponseDataInner and assigns it to the Data field.
func (o *GetZoneDeclarations200Response) SetData(v []GetZoneDeclarations200ResponseDataInner) {
	o.Data = v
}

func (o GetZoneDeclarations200Response) MarshalJSON() ([]byte, error) {
...
func (o GetZoneDeclarations200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetZoneDeclarations200Response struct {
	value *GetZoneDeclarations200Response
	isSet bool
}

func (v NullableGetZoneDeclarations200Response) Get() *GetZoneDeclarations200Response {
	return v.value
}

func (v *NullableGetZoneDeclarations200Response) Set(val *GetZoneDeclarations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneDeclarations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneDeclarations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneDeclarations200Response(val *GetZoneDeclarations200Response) *NullableGetZoneDeclarations200Response {
	return &NullableGetZoneDeclarations200Response{value: val, isSet: true}
}

func (v NullableGetZoneDeclarations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneDeclarations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
