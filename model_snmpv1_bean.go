...
// checks if the Snmpv1Bean type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Snmpv1Bean{}

// Snmpv1Bean struct for Snmpv1Bean
type Snmpv1Bean struct {
	SnmpBean
...
func (o Snmpv1Bean) MarshalJSON() ([]byte, error) {
...
func (o Snmpv1Bean) ToMap() (map[string]interface{}, error) {
...
type NullableSnmpv1Bean struct {
	value *Snmpv1Bean
	isSet bool
}

func (v NullableSnmpv1Bean) Get() *Snmpv1Bean {
	return v.value
}

func (v *NullableSnmpv1Bean) Set(val *Snmpv1Bean) {
	v.value = val
	v.isSet = true
}

func (v NullableSnmpv1Bean) IsSet() bool {
	return v.isSet
}

func (v *NullableSnmpv1Bean) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSnmpv1Bean(val *Snmpv1Bean) *NullableSnmpv1Bean {
	return &NullableSnmpv1Bean{value: val, isSet: true}
}

func (v NullableSnmpv1Bean) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSnmpv1Bean) UnmarshalJSON(src []byte) error {
	v.isSet = true
