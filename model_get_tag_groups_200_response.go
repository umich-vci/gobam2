...
// checks if the GetTagGroups200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTagGroups200Response{}

// GetTagGroups200Response struct for GetTagGroups200Response
type GetTagGroups200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetTagGroups200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetTagGroups200Response) GetData() []GetTagGroups200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTagGroups200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTagGroups200ResponseDataInner and assigns it to the Data field.
func (o *GetTagGroups200Response) SetData(v []GetTagGroups200ResponseDataInner) {
	o.Data = v
}

func (o GetTagGroups200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTagGroups200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTagGroups200Response struct {
	value *GetTagGroups200Response
	isSet bool
}

func (v NullableGetTagGroups200Response) Get() *GetTagGroups200Response {
	return v.value
}

func (v *NullableGetTagGroups200Response) Set(val *GetTagGroups200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTagGroups200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTagGroups200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTagGroups200Response(val *GetTagGroups200Response) *NullableGetTagGroups200Response {
	return &NullableGetTagGroups200Response{value: val, isSet: true}
}

func (v NullableGetTagGroups200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTagGroups200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
