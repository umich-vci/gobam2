...
// checks if the GetViews200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetViews200Response{}

// GetViews200Response struct for GetViews200Response
type GetViews200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetViews200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetViews200Response) GetData() []GetViews200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetViews200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetViews200ResponseDataInner and assigns it to the Data field.
func (o *GetViews200Response) SetData(v []GetViews200ResponseDataInner) {
	o.Data = v
}

func (o GetViews200Response) MarshalJSON() ([]byte, error) {
...
func (o GetViews200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetViews200Response struct {
	value *GetViews200Response
	isSet bool
}

func (v NullableGetViews200Response) Get() *GetViews200Response {
	return v.value
}

func (v *NullableGetViews200Response) Set(val *GetViews200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetViews200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetViews200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetViews200Response(val *GetViews200Response) *NullableGetViews200Response {
	return &NullableGetViews200Response{value: val, isSet: true}
}

func (v NullableGetViews200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetViews200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
