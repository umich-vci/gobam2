...
// checks if the GetServicePrincipals200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServicePrincipals200ResponseDataInner{}

// GetServicePrincipals200ResponseDataInner struct for GetServicePrincipals200ResponseDataInner
type GetServicePrincipals200ResponseDataInner struct {
...
func NewGetServicePrincipals200ResponseDataInner() *GetServicePrincipals200ResponseDataInner {
	this := GetServicePrincipals200ResponseDataInner{}
	return &this
}
...
func (o GetServicePrincipals200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetServicePrincipals200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetServicePrincipals200ResponseDataInner struct {
	value *GetServicePrincipals200ResponseDataInner
	isSet bool
}

func (v NullableGetServicePrincipals200ResponseDataInner) Get() *GetServicePrincipals200ResponseDataInner {
	return v.value
}

func (v *NullableGetServicePrincipals200ResponseDataInner) Set(val *GetServicePrincipals200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServicePrincipals200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServicePrincipals200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServicePrincipals200ResponseDataInner(val *GetServicePrincipals200ResponseDataInner) *NullableGetServicePrincipals200ResponseDataInner {
	return &NullableGetServicePrincipals200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetServicePrincipals200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServicePrincipals200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
