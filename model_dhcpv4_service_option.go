...
// checks if the DHCPv4ServiceOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPv4ServiceOption{}

// DHCPv4ServiceOption struct for DHCPv4ServiceOption
type DHCPv4ServiceOption struct {
	DeploymentOption
	// The resource type.
	...
	Definition *InlinedDHCPv4ServiceOptionDefinition `json:"definition,omitempty"`
}
...
func (o *DHCPv4ServiceOption) GetDefinition() InlinedDHCPv4ServiceOptionDefinition {
	if o == nil || IsNil(o.Definition) {
		var ret InlinedDHCPv4ServiceOptionDefinition
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given InlinedDHCPv4ServiceOptionDefinition and assigns it to the Definition field.
func (o *DHCPv4ServiceOption) SetDefinition(v InlinedDHCPv4ServiceOptionDefinition) {
	o.Definition = &v
}

func (o DHCPv4ServiceOption) MarshalJSON() ([]byte, error) {
...
func (o DHCPv4ServiceOption) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPv4ServiceOption struct {
	value *DHCPv4ServiceOption
	isSet bool
}

func (v NullableDHCPv4ServiceOption) Get() *DHCPv4ServiceOption {
	return v.value
}

func (v *NullableDHCPv4ServiceOption) Set(val *DHCPv4ServiceOption) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPv4ServiceOption) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPv4ServiceOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPv4ServiceOption(val *DHCPv4ServiceOption) *NullableDHCPv4ServiceOption {
	return &NullableDHCPv4ServiceOption{value: val, isSet: true}
}

func (v NullableDHCPv4ServiceOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPv4ServiceOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
