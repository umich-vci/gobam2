...
// checks if the GetZones200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZones200ResponseDataInner{}

// GetZones200ResponseDataInner struct for GetZones200ResponseDataInner
type GetZones200ResponseDataInner struct {
...
func NewGetZones200ResponseDataInner() *GetZones200ResponseDataInner {
	this := GetZones200ResponseDataInner{}
	return &this
}
...
func (o GetZones200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetZones200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetZones200ResponseDataInner struct {
	value *GetZones200ResponseDataInner
	isSet bool
}

func (v NullableGetZones200ResponseDataInner) Get() *GetZones200ResponseDataInner {
	return v.value
}

func (v *NullableGetZones200ResponseDataInner) Set(val *GetZones200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZones200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZones200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZones200ResponseDataInner(val *GetZones200ResponseDataInner) *NullableGetZones200ResponseDataInner {
	return &NullableGetZones200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetZones200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZones200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
