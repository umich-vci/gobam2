...
// checks if the DHCPZoneGroupPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPZoneGroupPutRequestBody{}

// DHCPZoneGroupPutRequestBody struct for DHCPZoneGroupPutRequestBody
type DHCPZoneGroupPutRequestBody struct {
...
func NewDHCPZoneGroupPutRequestBody() *DHCPZoneGroupPutRequestBody {
	this := DHCPZoneGroupPutRequestBody{}
	return &this
}
...
func (o DHCPZoneGroupPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DHCPZoneGroupPutRequestBody) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPZoneGroupPutRequestBody struct {
	value *DHCPZoneGroupPutRequestBody
	isSet bool
}

func (v NullableDHCPZoneGroupPutRequestBody) Get() *DHCPZoneGroupPutRequestBody {
	return v.value
}

func (v *NullableDHCPZoneGroupPutRequestBody) Set(val *DHCPZoneGroupPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPZoneGroupPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPZoneGroupPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPZoneGroupPutRequestBody(val *DHCPZoneGroupPutRequestBody) *NullableDHCPZoneGroupPutRequestBody {
	return &NullableDHCPZoneGroupPutRequestBody{value: val, isSet: true}
}

func (v NullableDHCPZoneGroupPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPZoneGroupPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
