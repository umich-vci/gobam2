...
// checks if the TFTPGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TFTPGroup{}

// TFTPGroup struct for TFTPGroup
type TFTPGroup struct {
...
func (o TFTPGroup) MarshalJSON() ([]byte, error) {
...
func (o TFTPGroup) ToMap() (map[string]interface{}, error) {
...
type NullableTFTPGroup struct {
	value *TFTPGroup
	isSet bool
}

func (v NullableTFTPGroup) Get() *TFTPGroup {
	return v.value
}

func (v *NullableTFTPGroup) Set(val *TFTPGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableTFTPGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableTFTPGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTFTPGroup(val *TFTPGroup) *NullableTFTPGroup {
	return &NullableTFTPGroup{value: val, isSet: true}
}

func (v NullableTFTPGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTFTPGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
