...
// checks if the InlinedDHCPUniqueIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedDHCPUniqueIdentifier{}

// InlinedDHCPUniqueIdentifier struct for InlinedDHCPUniqueIdentifier
...
func NewInlinedDHCPUniqueIdentifier() *InlinedDHCPUniqueIdentifier {
	this := InlinedDHCPUniqueIdentifier{}
	return &this
}
...
func (o InlinedDHCPUniqueIdentifier) MarshalJSON() ([]byte, error) {
...
func (o InlinedDHCPUniqueIdentifier) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedDHCPUniqueIdentifier struct {
	value *InlinedDHCPUniqueIdentifier
	isSet bool
}

func (v NullableInlinedDHCPUniqueIdentifier) Get() *InlinedDHCPUniqueIdentifier {
	return v.value
}

func (v *NullableInlinedDHCPUniqueIdentifier) Set(val *InlinedDHCPUniqueIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedDHCPUniqueIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedDHCPUniqueIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedDHCPUniqueIdentifier(val *InlinedDHCPUniqueIdentifier) *NullableInlinedDHCPUniqueIdentifier {
	return &NullableInlinedDHCPUniqueIdentifier{value: val, isSet: true}
}

func (v NullableInlinedDHCPUniqueIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedDHCPUniqueIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
