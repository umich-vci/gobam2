...
// checks if the InlinedResponsePolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedResponsePolicy{}

// InlinedResponsePolicy struct for InlinedResponsePolicy
...
func (o InlinedResponsePolicy) MarshalJSON() ([]byte, error) {
...
func (o InlinedResponsePolicy) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedResponsePolicy struct {
	value *InlinedResponsePolicy
	isSet bool
}

func (v NullableInlinedResponsePolicy) Get() *InlinedResponsePolicy {
	return v.value
}

func (v *NullableInlinedResponsePolicy) Set(val *InlinedResponsePolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedResponsePolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedResponsePolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedResponsePolicy(val *InlinedResponsePolicy) *NullableInlinedResponsePolicy {
	return &NullableInlinedResponsePolicy{value: val, isSet: true}
}

func (v NullableInlinedResponsePolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedResponsePolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
