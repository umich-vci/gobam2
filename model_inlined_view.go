...
// checks if the InlinedView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedView{}

// InlinedView struct for InlinedView
...
func (o InlinedView) MarshalJSON() ([]byte, error) {
...
func (o InlinedView) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedView struct {
	value *InlinedView
	isSet bool
}

func (v NullableInlinedView) Get() *InlinedView {
	return v.value
}

func (v *NullableInlinedView) Set(val *InlinedView) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedView) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedView(val *InlinedView) *NullableInlinedView {
	return &NullableInlinedView{value: val, isSet: true}
}

func (v NullableInlinedView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedView) UnmarshalJSON(src []byte) error {
	v.isSet = true
