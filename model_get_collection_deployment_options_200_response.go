...
// checks if the GetCollectionDeploymentOptions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionDeploymentOptions200Response{}

// GetCollectionDeploymentOptions200Response struct for GetCollectionDeploymentOptions200Response
type GetCollectionDeploymentOptions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionDeploymentOptions200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionDeploymentOptions200Response() *GetCollectionDeploymentOptions200Response {
	this := GetCollectionDeploymentOptions200Response{}
	return &this
}
...
func (o *GetCollectionDeploymentOptions200Response) GetData() []GetCollectionDeploymentOptions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionDeploymentOptions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionDeploymentOptions200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionDeploymentOptions200Response) SetData(v []GetCollectionDeploymentOptions200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionDeploymentOptions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionDeploymentOptions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionDeploymentOptions200Response struct {
	value *GetCollectionDeploymentOptions200Response
	isSet bool
}

func (v NullableGetCollectionDeploymentOptions200Response) Get() *GetCollectionDeploymentOptions200Response {
	return v.value
}

func (v *NullableGetCollectionDeploymentOptions200Response) Set(val *GetCollectionDeploymentOptions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionDeploymentOptions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionDeploymentOptions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionDeploymentOptions200Response(val *GetCollectionDeploymentOptions200Response) *NullableGetCollectionDeploymentOptions200Response {
	return &NullableGetCollectionDeploymentOptions200Response{value: val, isSet: true}
}

func (v NullableGetCollectionDeploymentOptions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionDeploymentOptions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
