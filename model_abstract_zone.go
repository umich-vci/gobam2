...
// checks if the AbstractZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbstractZone{}

// AbstractZone struct for AbstractZone
type AbstractZone struct {
...
func (o AbstractZone) MarshalJSON() ([]byte, error) {
...
func (o AbstractZone) ToMap() (map[string]interface{}, error) {
...
type NullableAbstractZone struct {
	value *AbstractZone
	isSet bool
}

func (v NullableAbstractZone) Get() *AbstractZone {
	return v.value
}

func (v *NullableAbstractZone) Set(val *AbstractZone) {
	v.value = val
	v.isSet = true
}

func (v NullableAbstractZone) IsSet() bool {
	return v.isSet
}

func (v *NullableAbstractZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbstractZone(val *AbstractZone) *NullableAbstractZone {
	return &NullableAbstractZone{value: val, isSet: true}
}

func (v NullableAbstractZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbstractZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
