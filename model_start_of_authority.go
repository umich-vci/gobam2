...
// checks if the StartOfAuthority type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StartOfAuthority{}

// StartOfAuthority struct for StartOfAuthority
...
func (o StartOfAuthority) MarshalJSON() ([]byte, error) {
...
func (o StartOfAuthority) ToMap() (map[string]interface{}, error) {
...
type NullableStartOfAuthority struct {
	value *StartOfAuthority
	isSet bool
}

func (v NullableStartOfAuthority) Get() *StartOfAuthority {
	return v.value
}

func (v *NullableStartOfAuthority) Set(val *StartOfAuthority) {
	v.value = val
	v.isSet = true
}

func (v NullableStartOfAuthority) IsSet() bool {
	return v.isSet
}

func (v *NullableStartOfAuthority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStartOfAuthority(val *StartOfAuthority) *NullableStartOfAuthority {
	return &NullableStartOfAuthority{value: val, isSet: true}
}

func (v NullableStartOfAuthority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStartOfAuthority) UnmarshalJSON(src []byte) error {
	v.isSet = true
