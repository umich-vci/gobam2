...
// checks if the GetAuthenticators200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAuthenticators200Response{}

// GetAuthenticators200Response struct for GetAuthenticators200Response
type GetAuthenticators200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetAuthenticators200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetAuthenticators200Response() *GetAuthenticators200Response {
	this := GetAuthenticators200Response{}
	return &this
}
...
func (o *GetAuthenticators200Response) GetData() []GetAuthenticators200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetAuthenticators200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetAuthenticators200ResponseDataInner and assigns it to the Data field.
func (o *GetAuthenticators200Response) SetData(v []GetAuthenticators200ResponseDataInner) {
	o.Data = v
}

func (o GetAuthenticators200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAuthenticators200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetAuthenticators200Response struct {
	value *GetAuthenticators200Response
	isSet bool
}

func (v NullableGetAuthenticators200Response) Get() *GetAuthenticators200Response {
	return v.value
}

func (v *NullableGetAuthenticators200Response) Set(val *GetAuthenticators200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAuthenticators200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAuthenticators200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAuthenticators200Response(val *GetAuthenticators200Response) *NullableGetAuthenticators200Response {
	return &NullableGetAuthenticators200Response{value: val, isSet: true}
}

func (v NullableGetAuthenticators200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAuthenticators200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
