...
// checks if the GetTemplates200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTemplates200ResponseDataInner{}

// GetTemplates200ResponseDataInner struct for GetTemplates200ResponseDataInner
type GetTemplates200ResponseDataInner struct {
...
func NewGetTemplates200ResponseDataInner() *GetTemplates200ResponseDataInner {
	this := GetTemplates200ResponseDataInner{}
	return &this
}
...
func (o GetTemplates200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTemplates200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTemplates200ResponseDataInner struct {
	value *GetTemplates200ResponseDataInner
	isSet bool
}

func (v NullableGetTemplates200ResponseDataInner) Get() *GetTemplates200ResponseDataInner {
	return v.value
}

func (v *NullableGetTemplates200ResponseDataInner) Set(val *GetTemplates200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTemplates200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTemplates200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTemplates200ResponseDataInner(val *GetTemplates200ResponseDataInner) *NullableGetTemplates200ResponseDataInner {
	return &NullableGetTemplates200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetTemplates200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTemplates200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
