...
// checks if the GetCollectionRestrictedRanges200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionRestrictedRanges200Response{}

// GetCollectionRestrictedRanges200Response struct for GetCollectionRestrictedRanges200Response
type GetCollectionRestrictedRanges200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionRestrictedRanges200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionRestrictedRanges200Response() *GetCollectionRestrictedRanges200Response {
	this := GetCollectionRestrictedRanges200Response{}
	return &this
}
...
func (o *GetCollectionRestrictedRanges200Response) GetData() []GetCollectionRestrictedRanges200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionRestrictedRanges200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionRestrictedRanges200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionRestrictedRanges200Response) SetData(v []GetCollectionRestrictedRanges200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionRestrictedRanges200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionRestrictedRanges200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionRestrictedRanges200Response struct {
	value *GetCollectionRestrictedRanges200Response
	isSet bool
}

func (v NullableGetCollectionRestrictedRanges200Response) Get() *GetCollectionRestrictedRanges200Response {
	return v.value
}

func (v *NullableGetCollectionRestrictedRanges200Response) Set(val *GetCollectionRestrictedRanges200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionRestrictedRanges200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionRestrictedRanges200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionRestrictedRanges200Response(val *GetCollectionRestrictedRanges200Response) *NullableGetCollectionRestrictedRanges200Response {
	return &NullableGetCollectionRestrictedRanges200Response{value: val, isSet: true}
}

func (v NullableGetCollectionRestrictedRanges200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionRestrictedRanges200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
