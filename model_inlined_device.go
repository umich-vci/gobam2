...
// checks if the InlinedDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedDevice{}

// InlinedDevice struct for InlinedDevice
...
func (o InlinedDevice) MarshalJSON() ([]byte, error) {
...
func (o InlinedDevice) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedDevice struct {
	value *InlinedDevice
	isSet bool
}

func (v NullableInlinedDevice) Get() *InlinedDevice {
	return v.value
}

func (v *NullableInlinedDevice) Set(val *InlinedDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedDevice(val *InlinedDevice) *NullableInlinedDevice {
	return &NullableInlinedDevice{value: val, isSet: true}
}

func (v NullableInlinedDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
