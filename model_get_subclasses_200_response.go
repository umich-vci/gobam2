...
// checks if the GetSubclasses200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSubclasses200Response{}

// GetSubclasses200Response struct for GetSubclasses200Response
type GetSubclasses200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetSubclasses200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetSubclasses200Response) GetData() []GetSubclasses200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetSubclasses200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetSubclasses200ResponseDataInner and assigns it to the Data field.
func (o *GetSubclasses200Response) SetData(v []GetSubclasses200ResponseDataInner) {
	o.Data = v
}

func (o GetSubclasses200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSubclasses200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSubclasses200Response struct {
	value *GetSubclasses200Response
	isSet bool
}

func (v NullableGetSubclasses200Response) Get() *GetSubclasses200Response {
	return v.value
}

func (v *NullableGetSubclasses200Response) Set(val *GetSubclasses200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSubclasses200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSubclasses200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSubclasses200Response(val *GetSubclasses200Response) *NullableGetSubclasses200Response {
	return &NullableGetSubclasses200Response{value: val, isSet: true}
}

func (v NullableGetSubclasses200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSubclasses200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
