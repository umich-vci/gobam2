...
// checks if the GetReconciliationPolicyDiscoveredDevices200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetReconciliationPolicyDiscoveredDevices200Response{}

// GetReconciliationPolicyDiscoveredDevices200Response struct for GetReconciliationPolicyDiscoveredDevices200Response
type GetReconciliationPolicyDiscoveredDevices200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetReconciliationPolicyDiscoveredDevices200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetReconciliationPolicyDiscoveredDevices200Response() *GetReconciliationPolicyDiscoveredDevices200Response {
	this := GetReconciliationPolicyDiscoveredDevices200Response{}
	return &this
}
...
func (o *GetReconciliationPolicyDiscoveredDevices200Response) GetData() []GetReconciliationPolicyDiscoveredDevices200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetReconciliationPolicyDiscoveredDevices200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetReconciliationPolicyDiscoveredDevices200ResponseDataInner and assigns it to the Data field.
...
func (o GetReconciliationPolicyDiscoveredDevices200Response) MarshalJSON() ([]byte, error) {
...
func (o GetReconciliationPolicyDiscoveredDevices200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetReconciliationPolicyDiscoveredDevices200Response struct {
	value *GetReconciliationPolicyDiscoveredDevices200Response
	isSet bool
}

func (v NullableGetReconciliationPolicyDiscoveredDevices200Response) Get() *GetReconciliationPolicyDiscoveredDevices200Response {
	return v.value
}

func (v *NullableGetReconciliationPolicyDiscoveredDevices200Response) Set(val *GetReconciliationPolicyDiscoveredDevices200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetReconciliationPolicyDiscoveredDevices200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetReconciliationPolicyDiscoveredDevices200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetReconciliationPolicyDiscoveredDevices200Response(val *GetReconciliationPolicyDiscoveredDevices200Response) *NullableGetReconciliationPolicyDiscoveredDevices200Response {
	return &NullableGetReconciliationPolicyDiscoveredDevices200Response{value: val, isSet: true}
}

func (v NullableGetReconciliationPolicyDiscoveredDevices200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetReconciliationPolicyDiscoveredDevices200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
