...
// checks if the GetCollectionRestrictedRanges200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionRestrictedRanges200ResponseDataInner{}

// GetCollectionRestrictedRanges200ResponseDataInner struct for GetCollectionRestrictedRanges200ResponseDataInner
type GetCollectionRestrictedRanges200ResponseDataInner struct {
...
func NewGetCollectionRestrictedRanges200ResponseDataInner() *GetCollectionRestrictedRanges200ResponseDataInner {
	this := GetCollectionRestrictedRanges200ResponseDataInner{}
	return &this
}
...
func (o GetCollectionRestrictedRanges200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionRestrictedRanges200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionRestrictedRanges200ResponseDataInner struct {
	value *GetCollectionRestrictedRanges200ResponseDataInner
	isSet bool
}

func (v NullableGetCollectionRestrictedRanges200ResponseDataInner) Get() *GetCollectionRestrictedRanges200ResponseDataInner {
	return v.value
}

func (v *NullableGetCollectionRestrictedRanges200ResponseDataInner) Set(val *GetCollectionRestrictedRanges200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionRestrictedRanges200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionRestrictedRanges200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionRestrictedRanges200ResponseDataInner(val *GetCollectionRestrictedRanges200ResponseDataInner) *NullableGetCollectionRestrictedRanges200ResponseDataInner {
	return &NullableGetCollectionRestrictedRanges200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetCollectionRestrictedRanges200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionRestrictedRanges200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
