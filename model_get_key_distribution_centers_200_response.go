...
// checks if the GetKeyDistributionCenters200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetKeyDistributionCenters200Response{}

// GetKeyDistributionCenters200Response struct for GetKeyDistributionCenters200Response
type GetKeyDistributionCenters200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetKeyDistributionCenters200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetKeyDistributionCenters200Response() *GetKeyDistributionCenters200Response {
	this := GetKeyDistributionCenters200Response{}
	return &this
}
...
func (o *GetKeyDistributionCenters200Response) GetData() []GetKeyDistributionCenters200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetKeyDistributionCenters200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetKeyDistributionCenters200ResponseDataInner and assigns it to the Data field.
func (o *GetKeyDistributionCenters200Response) SetData(v []GetKeyDistributionCenters200ResponseDataInner) {
	o.Data = v
}

func (o GetKeyDistributionCenters200Response) MarshalJSON() ([]byte, error) {
...
func (o GetKeyDistributionCenters200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetKeyDistributionCenters200Response struct {
	value *GetKeyDistributionCenters200Response
	isSet bool
}

func (v NullableGetKeyDistributionCenters200Response) Get() *GetKeyDistributionCenters200Response {
	return v.value
}

func (v *NullableGetKeyDistributionCenters200Response) Set(val *GetKeyDistributionCenters200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetKeyDistributionCenters200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetKeyDistributionCenters200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetKeyDistributionCenters200Response(val *GetKeyDistributionCenters200Response) *NullableGetKeyDistributionCenters200Response {
	return &NullableGetKeyDistributionCenters200Response{value: val, isSet: true}
}

func (v NullableGetKeyDistributionCenters200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetKeyDistributionCenters200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
