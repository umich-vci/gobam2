...
// checks if the GetUserDefinedLinkDefinitions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserDefinedLinkDefinitions200Response{}

// GetUserDefinedLinkDefinitions200Response struct for GetUserDefinedLinkDefinitions200Response
type GetUserDefinedLinkDefinitions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetUserDefinedLinkDefinitions200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetUserDefinedLinkDefinitions200Response() *GetUserDefinedLinkDefinitions200Response {
	this := GetUserDefinedLinkDefinitions200Response{}
	return &this
}
...
func (o *GetUserDefinedLinkDefinitions200Response) GetData() []GetUserDefinedLinkDefinitions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetUserDefinedLinkDefinitions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetUserDefinedLinkDefinitions200ResponseDataInner and assigns it to the Data field.
func (o *GetUserDefinedLinkDefinitions200Response) SetData(v []GetUserDefinedLinkDefinitions200ResponseDataInner) {
	o.Data = v
}

func (o GetUserDefinedLinkDefinitions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetUserDefinedLinkDefinitions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetUserDefinedLinkDefinitions200Response struct {
	value *GetUserDefinedLinkDefinitions200Response
	isSet bool
}

func (v NullableGetUserDefinedLinkDefinitions200Response) Get() *GetUserDefinedLinkDefinitions200Response {
	return v.value
}

func (v *NullableGetUserDefinedLinkDefinitions200Response) Set(val *GetUserDefinedLinkDefinitions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserDefinedLinkDefinitions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserDefinedLinkDefinitions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserDefinedLinkDefinitions200Response(val *GetUserDefinedLinkDefinitions200Response) *NullableGetUserDefinedLinkDefinitions200Response {
	return &NullableGetUserDefinedLinkDefinitions200Response{value: val, isSet: true}
}

func (v NullableGetUserDefinedLinkDefinitions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserDefinedLinkDefinitions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
