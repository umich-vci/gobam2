...
// checks if the IPv4Template type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPv4Template{}

// IPv4Template struct for IPv4Template
...
func (o IPv4Template) MarshalJSON() ([]byte, error) {
...
func (o IPv4Template) ToMap() (map[string]interface{}, error) {
...
type NullableIPv4Template struct {
	value *IPv4Template
	isSet bool
}

func (v NullableIPv4Template) Get() *IPv4Template {
	return v.value
}

func (v *NullableIPv4Template) Set(val *IPv4Template) {
	v.value = val
	v.isSet = true
}

func (v NullableIPv4Template) IsSet() bool {
	return v.isSet
}

func (v *NullableIPv4Template) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPv4Template(val *IPv4Template) *NullableIPv4Template {
	return &NullableIPv4Template{value: val, isSet: true}
}

func (v NullableIPv4Template) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPv4Template) UnmarshalJSON(src []byte) error {
	v.isSet = true
