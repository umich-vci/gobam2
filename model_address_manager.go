...
// checks if the AddressManager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressManager{}

// AddressManager struct for AddressManager
...
func (o AddressManager) MarshalJSON() ([]byte, error) {
...
func (o AddressManager) ToMap() (map[string]interface{}, error) {
...
type NullableAddressManager struct {
	value *AddressManager
	isSet bool
}

func (v NullableAddressManager) Get() *AddressManager {
	return v.value
}

func (v *NullableAddressManager) Set(val *AddressManager) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressManager) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressManager(val *AddressManager) *NullableAddressManager {
	return &NullableAddressManager{value: val, isSet: true}
}

func (v NullableAddressManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
