...
// checks if the IPv6ReconciliationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPv6ReconciliationPolicy{}

// IPv6ReconciliationPolicy struct for IPv6ReconciliationPolicy
type IPv6ReconciliationPolicy struct {
...
func (o IPv6ReconciliationPolicy) MarshalJSON() ([]byte, error) {
...
func (o IPv6ReconciliationPolicy) ToMap() (map[string]interface{}, error) {
...
type NullableIPv6ReconciliationPolicy struct {
	value *IPv6ReconciliationPolicy
	isSet bool
}

func (v NullableIPv6ReconciliationPolicy) Get() *IPv6ReconciliationPolicy {
	return v.value
}

func (v *NullableIPv6ReconciliationPolicy) Set(val *IPv6ReconciliationPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableIPv6ReconciliationPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableIPv6ReconciliationPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPv6ReconciliationPolicy(val *IPv6ReconciliationPolicy) *NullableIPv6ReconciliationPolicy {
	return &NullableIPv6ReconciliationPolicy{value: val, isSet: true}
}

func (v NullableIPv6ReconciliationPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPv6ReconciliationPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
