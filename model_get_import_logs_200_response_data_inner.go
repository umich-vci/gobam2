...
// checks if the GetImportLogs200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetImportLogs200ResponseDataInner{}

// GetImportLogs200ResponseDataInner struct for GetImportLogs200ResponseDataInner
type GetImportLogs200ResponseDataInner struct {
...
func NewGetImportLogs200ResponseDataInner() *GetImportLogs200ResponseDataInner {
	this := GetImportLogs200ResponseDataInner{}
	return &this
}
...
func (o GetImportLogs200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetImportLogs200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetImportLogs200ResponseDataInner struct {
	value *GetImportLogs200ResponseDataInner
	isSet bool
}

func (v NullableGetImportLogs200ResponseDataInner) Get() *GetImportLogs200ResponseDataInner {
	return v.value
}

func (v *NullableGetImportLogs200ResponseDataInner) Set(val *GetImportLogs200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetImportLogs200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetImportLogs200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetImportLogs200ResponseDataInner(val *GetImportLogs200ResponseDataInner) *NullableGetImportLogs200ResponseDataInner {
	return &NullableGetImportLogs200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetImportLogs200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetImportLogs200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
