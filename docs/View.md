...
`func (o *View) GetUserDefinedFields() map[string]string`

GetUserDefinedFields returns the UserDefinedFields field if non-nil, zero value otherwise.

### GetUserDefinedFieldsOk

`func (o *View) GetUserDefinedFieldsOk() (*map[string]string, bool)`
...
`func (o *View) SetUserDefinedFields(v map[string]string)`

SetUserDefinedFields sets UserDefinedFields field to given value.

### HasUserDefinedFields

`func (o *View) HasUserDefinedFields() bool`

HasUserDefinedFields returns a boolean if a field has been set.

### GetConfiguration

`func (o *View) GetConfiguration() InlinedConfiguration`

GetConfiguration returns the Configuration field if non-nil, zero value otherwise.

### GetConfigurationOk

`func (o *View) GetConfigurationOk() (*InlinedConfiguration, bool)`
...
`func (o *View) SetConfiguration(v InlinedConfiguration)`

SetConfiguration sets Configuration field to given value.

### HasConfiguration

`func (o *View) HasConfiguration() bool`

HasConfiguration returns a boolean if a field has been set.

### GetDeviceRegistrationEnabled

`func (o *View) GetDeviceRegistrationEnabled() bool`
...
`func (o *View) GetDeviceRegistrationEnabledOk() (*bool, bool)`
...
`func (o *View) GetDeviceRegistrationPortalAddressOk() (*string, bool)`
...
`func (o *View) SetDeviceRegistrationPortalAddress(v string)`
...
`func (o *View) HasDeviceRegistrationPortalAddress() bool`
