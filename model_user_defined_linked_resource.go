...
// checks if the UserDefinedLinkedResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDefinedLinkedResource{}

// UserDefinedLinkedResource struct for UserDefinedLinkedResource
type UserDefinedLinkedResource struct {
...
func NewUserDefinedLinkedResource() *UserDefinedLinkedResource {
	this := UserDefinedLinkedResource{}
	return &this
}
...
func (o UserDefinedLinkedResource) MarshalJSON() ([]byte, error) {
...
func (o UserDefinedLinkedResource) ToMap() (map[string]interface{}, error) {
...
type NullableUserDefinedLinkedResource struct {
	value *UserDefinedLinkedResource
	isSet bool
}

func (v NullableUserDefinedLinkedResource) Get() *UserDefinedLinkedResource {
	return v.value
}

func (v *NullableUserDefinedLinkedResource) Set(val *UserDefinedLinkedResource) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDefinedLinkedResource) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDefinedLinkedResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDefinedLinkedResource(val *UserDefinedLinkedResource) *NullableUserDefinedLinkedResource {
	return &NullableUserDefinedLinkedResource{value: val, isSet: true}
}

func (v NullableUserDefinedLinkedResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDefinedLinkedResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
