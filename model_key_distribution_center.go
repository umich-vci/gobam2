...
// checks if the KeyDistributionCenter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyDistributionCenter{}

// KeyDistributionCenter struct for KeyDistributionCenter
...
func (o KeyDistributionCenter) MarshalJSON() ([]byte, error) {
...
func (o KeyDistributionCenter) ToMap() (map[string]interface{}, error) {
...
type NullableKeyDistributionCenter struct {
	value *KeyDistributionCenter
	isSet bool
}

func (v NullableKeyDistributionCenter) Get() *KeyDistributionCenter {
	return v.value
}

func (v *NullableKeyDistributionCenter) Set(val *KeyDistributionCenter) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyDistributionCenter) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyDistributionCenter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyDistributionCenter(val *KeyDistributionCenter) *NullableKeyDistributionCenter {
	return &NullableKeyDistributionCenter{value: val, isSet: true}
}

func (v NullableKeyDistributionCenter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyDistributionCenter) UnmarshalJSON(src []byte) error {
	v.isSet = true
