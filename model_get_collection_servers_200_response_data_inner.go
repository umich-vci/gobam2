...
// checks if the GetCollectionServers200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionServers200ResponseDataInner{}

// GetCollectionServers200ResponseDataInner struct for GetCollectionServers200ResponseDataInner
type GetCollectionServers200ResponseDataInner struct {
...
func NewGetCollectionServers200ResponseDataInner() *GetCollectionServers200ResponseDataInner {
	this := GetCollectionServers200ResponseDataInner{}
	return &this
}
...
func (o GetCollectionServers200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionServers200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionServers200ResponseDataInner struct {
	value *GetCollectionServers200ResponseDataInner
	isSet bool
}

func (v NullableGetCollectionServers200ResponseDataInner) Get() *GetCollectionServers200ResponseDataInner {
	return v.value
}

func (v *NullableGetCollectionServers200ResponseDataInner) Set(val *GetCollectionServers200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionServers200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionServers200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionServers200ResponseDataInner(val *GetCollectionServers200ResponseDataInner) *NullableGetCollectionServers200ResponseDataInner {
	return &NullableGetCollectionServers200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetCollectionServers200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionServers200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
