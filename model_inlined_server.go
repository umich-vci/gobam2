...
// checks if the InlinedServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedServer{}

// InlinedServer struct for InlinedServer
type InlinedServer struct {
...
func (o InlinedServer) MarshalJSON() ([]byte, error) {
...
func (o InlinedServer) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedServer struct {
	value *InlinedServer
	isSet bool
}

func (v NullableInlinedServer) Get() *InlinedServer {
	return v.value
}

func (v *NullableInlinedServer) Set(val *InlinedServer) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedServer) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedServer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedServer(val *InlinedServer) *NullableInlinedServer {
	return &NullableInlinedServer{value: val, isSet: true}
}

func (v NullableInlinedServer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedServer) UnmarshalJSON(src []byte) error {
	v.isSet = true
