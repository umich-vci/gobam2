...
// checks if the GetServerGroups200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerGroups200ResponseDataInner{}

// GetServerGroups200ResponseDataInner struct for GetServerGroups200ResponseDataInner
type GetServerGroups200ResponseDataInner struct {
...
func NewGetServerGroups200ResponseDataInner() *GetServerGroups200ResponseDataInner {
	this := GetServerGroups200ResponseDataInner{}
	return &this
}
...
func (o GetServerGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetServerGroups200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerGroups200ResponseDataInner struct {
	value *GetServerGroups200ResponseDataInner
	isSet bool
}

func (v NullableGetServerGroups200ResponseDataInner) Get() *GetServerGroups200ResponseDataInner {
	return v.value
}

func (v *NullableGetServerGroups200ResponseDataInner) Set(val *GetServerGroups200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerGroups200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerGroups200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerGroups200ResponseDataInner(val *GetServerGroups200ResponseDataInner) *NullableGetServerGroups200ResponseDataInner {
	return &NullableGetServerGroups200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetServerGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerGroups200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
