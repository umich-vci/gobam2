...
// checks if the KerberosServicePrincipalPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosServicePrincipalPutRequestBody{}

// KerberosServicePrincipalPutRequestBody struct for KerberosServicePrincipalPutRequestBody
type KerberosServicePrincipalPutRequestBody struct {
...
type _KerberosServicePrincipalPutRequestBody KerberosServicePrincipalPutRequestBody
...
func NewKerberosServicePrincipalPutRequestBody(name string, keyVersionNumber int32) *KerberosServicePrincipalPutRequestBody {
	this := KerberosServicePrincipalPutRequestBody{}
	this.Name = name
...
func (o KerberosServicePrincipalPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o KerberosServicePrincipalPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *KerberosServicePrincipalPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varKerberosServicePrincipalPutRequestBody := _KerberosServicePrincipalPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKerberosServicePrincipalPutRequestBody)

	if err != nil {
		return err
	}

	*o = KerberosServicePrincipalPutRequestBody(varKerberosServicePrincipalPutRequestBody)

	return err
}

type NullableKerberosServicePrincipalPutRequestBody struct {
	value *KerberosServicePrincipalPutRequestBody
	isSet bool
}

func (v NullableKerberosServicePrincipalPutRequestBody) Get() *KerberosServicePrincipalPutRequestBody {
	return v.value
}

func (v *NullableKerberosServicePrincipalPutRequestBody) Set(val *KerberosServicePrincipalPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableKerberosServicePrincipalPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableKerberosServicePrincipalPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKerberosServicePrincipalPutRequestBody(val *KerberosServicePrincipalPutRequestBody) *NullableKerberosServicePrincipalPutRequestBody {
	return &NullableKerberosServicePrincipalPutRequestBody{value: val, isSet: true}
}

func (v NullableKerberosServicePrincipalPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKerberosServicePrincipalPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
