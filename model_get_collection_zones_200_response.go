...
// checks if the GetCollectionZones200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionZones200Response{}

// GetCollectionZones200Response struct for GetCollectionZones200Response
type GetCollectionZones200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionZones200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionZones200Response() *GetCollectionZones200Response {
	this := GetCollectionZones200Response{}
	return &this
}
...
func (o *GetCollectionZones200Response) GetData() []GetCollectionZones200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionZones200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionZones200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionZones200Response) SetData(v []GetCollectionZones200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionZones200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionZones200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionZones200Response struct {
	value *GetCollectionZones200Response
	isSet bool
}

func (v NullableGetCollectionZones200Response) Get() *GetCollectionZones200Response {
	return v.value
}

func (v *NullableGetCollectionZones200Response) Set(val *GetCollectionZones200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionZones200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionZones200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionZones200Response(val *GetCollectionZones200Response) *NullableGetCollectionZones200Response {
	return &NullableGetCollectionZones200Response{value: val, isSet: true}
}

func (v NullableGetCollectionZones200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionZones200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
