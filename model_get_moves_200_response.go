...
// checks if the GetMoves200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMoves200Response{}

// GetMoves200Response struct for GetMoves200Response
type GetMoves200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetMoves200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetMoves200Response) GetData() []GetMoves200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetMoves200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetMoves200ResponseDataInner and assigns it to the Data field.
func (o *GetMoves200Response) SetData(v []GetMoves200ResponseDataInner) {
	o.Data = v
}

func (o GetMoves200Response) MarshalJSON() ([]byte, error) {
...
func (o GetMoves200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetMoves200Response struct {
	value *GetMoves200Response
	isSet bool
}

func (v NullableGetMoves200Response) Get() *GetMoves200Response {
	return v.value
}

func (v *NullableGetMoves200Response) Set(val *GetMoves200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMoves200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMoves200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMoves200Response(val *GetMoves200Response) *NullableGetMoves200Response {
	return &NullableGetMoves200Response{value: val, isSet: true}
}

func (v NullableGetMoves200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMoves200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
