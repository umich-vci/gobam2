...
// checks if the DNSOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DNSOption{}

// DNSOption struct for DNSOption
type DNSOption struct {
	DeploymentOption
	// The resource type.
	Type *string `json:"type,omitempty"`
	Value map[string]interface{} `json:"value,omitempty"`
	// The code for the DNS option definition.
	Code *float32 `json:"code,omitempty"`
	Definition *InlinedDNSOptionDefinition `json:"definition,omitempty"`
}
...
func (o *DNSOption) GetDefinition() InlinedDNSOptionDefinition {
	if o == nil || IsNil(o.Definition) {
		var ret InlinedDNSOptionDefinition
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given InlinedDNSOptionDefinition and assigns it to the Definition field.
func (o *DNSOption) SetDefinition(v InlinedDNSOptionDefinition) {
	o.Definition = &v
}

func (o DNSOption) MarshalJSON() ([]byte, error) {
...
func (o DNSOption) ToMap() (map[string]interface{}, error) {
...
type NullableDNSOption struct {
	value *DNSOption
	isSet bool
}

func (v NullableDNSOption) Get() *DNSOption {
	return v.value
}

func (v *NullableDNSOption) Set(val *DNSOption) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSOption) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSOption(val *DNSOption) *NullableDNSOption {
	return &NullableDNSOption{value: val, isSet: true}
}

func (v NullableDNSOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDNSOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
