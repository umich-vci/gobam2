...
// checks if the ACLPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ACLPutRequestBody{}

// ACLPutRequestBody struct for ACLPutRequestBody
type ACLPutRequestBody struct {
...
type _ACLPutRequestBody ACLPutRequestBody
...
func (o ACLPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o ACLPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *ACLPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varACLPutRequestBody := _ACLPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varACLPutRequestBody)

	if err != nil {
		return err
	}

	*o = ACLPutRequestBody(varACLPutRequestBody)

	return err
}

type NullableACLPutRequestBody struct {
	value *ACLPutRequestBody
	isSet bool
}

func (v NullableACLPutRequestBody) Get() *ACLPutRequestBody {
	return v.value
}

func (v *NullableACLPutRequestBody) Set(val *ACLPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableACLPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableACLPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableACLPutRequestBody(val *ACLPutRequestBody) *NullableACLPutRequestBody {
	return &NullableACLPutRequestBody{value: val, isSet: true}
}

func (v NullableACLPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableACLPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
