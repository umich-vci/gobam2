...
// checks if the GetResources200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetResources200ResponseDataInner{}

// GetResources200ResponseDataInner struct for GetResources200ResponseDataInner
type GetResources200ResponseDataInner struct {
...
func NewGetResources200ResponseDataInner() *GetResources200ResponseDataInner {
	this := GetResources200ResponseDataInner{}
	return &this
}
...
func (o GetResources200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetResources200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetResources200ResponseDataInner struct {
	value *GetResources200ResponseDataInner
	isSet bool
}

func (v NullableGetResources200ResponseDataInner) Get() *GetResources200ResponseDataInner {
	return v.value
}

func (v *NullableGetResources200ResponseDataInner) Set(val *GetResources200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetResources200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetResources200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetResources200ResponseDataInner(val *GetResources200ResponseDataInner) *NullableGetResources200ResponseDataInner {
	return &NullableGetResources200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetResources200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetResources200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
