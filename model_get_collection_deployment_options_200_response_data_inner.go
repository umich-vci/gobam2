...
// checks if the GetCollectionDeploymentOptions200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionDeploymentOptions200ResponseDataInner{}

// GetCollectionDeploymentOptions200ResponseDataInner struct for GetCollectionDeploymentOptions200ResponseDataInner
type GetCollectionDeploymentOptions200ResponseDataInner struct {
	...
	Definition *InlinedStartOfAuthorityDefinition `json:"definition,omitempty"`
...
func NewGetCollectionDeploymentOptions200ResponseDataInner() *GetCollectionDeploymentOptions200ResponseDataInner {
	this := GetCollectionDeploymentOptions200ResponseDataInner{}
	return &this
}
...
func (o *GetCollectionDeploymentOptions200ResponseDataInner) GetDefinition() InlinedStartOfAuthorityDefinition {
	if o == nil || IsNil(o.Definition) {
		var ret InlinedStartOfAuthorityDefinition
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given InlinedStartOfAuthorityDefinition and assigns it to the Definition field.
...
func (o GetCollectionDeploymentOptions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionDeploymentOptions200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionDeploymentOptions200ResponseDataInner struct {
	value *GetCollectionDeploymentOptions200ResponseDataInner
	isSet bool
}

func (v NullableGetCollectionDeploymentOptions200ResponseDataInner) Get() *GetCollectionDeploymentOptions200ResponseDataInner {
	return v.value
}

func (v *NullableGetCollectionDeploymentOptions200ResponseDataInner) Set(val *GetCollectionDeploymentOptions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionDeploymentOptions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionDeploymentOptions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionDeploymentOptions200ResponseDataInner(val *GetCollectionDeploymentOptions200ResponseDataInner) *NullableGetCollectionDeploymentOptions200ResponseDataInner {
	return &NullableGetCollectionDeploymentOptions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetCollectionDeploymentOptions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionDeploymentOptions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
