...
// checks if the InlinedLinkedResourceRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedLinkedResourceRecord{}

// InlinedLinkedResourceRecord struct for InlinedLinkedResourceRecord
type InlinedLinkedResourceRecord struct {
...
func NewInlinedLinkedResourceRecord() *InlinedLinkedResourceRecord {
	this := InlinedLinkedResourceRecord{}
	return &this
}
...
func (o InlinedLinkedResourceRecord) MarshalJSON() ([]byte, error) {
...
func (o InlinedLinkedResourceRecord) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedLinkedResourceRecord struct {
	value *InlinedLinkedResourceRecord
	isSet bool
}

func (v NullableInlinedLinkedResourceRecord) Get() *InlinedLinkedResourceRecord {
	return v.value
}

func (v *NullableInlinedLinkedResourceRecord) Set(val *InlinedLinkedResourceRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedLinkedResourceRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedLinkedResourceRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedLinkedResourceRecord(val *InlinedLinkedResourceRecord) *NullableInlinedLinkedResourceRecord {
	return &NullableInlinedLinkedResourceRecord{value: val, isSet: true}
}

func (v NullableInlinedLinkedResourceRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedLinkedResourceRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
