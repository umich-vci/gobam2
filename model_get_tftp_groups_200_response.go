...
// checks if the GetTftpGroups200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTftpGroups200Response{}

// GetTftpGroups200Response struct for GetTftpGroups200Response
type GetTftpGroups200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetTftpGroups200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetTftpGroups200Response) GetData() []GetTftpGroups200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTftpGroups200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTftpGroups200ResponseDataInner and assigns it to the Data field.
func (o *GetTftpGroups200Response) SetData(v []GetTftpGroups200ResponseDataInner) {
	o.Data = v
}

func (o GetTftpGroups200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTftpGroups200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTftpGroups200Response struct {
	value *GetTftpGroups200Response
	isSet bool
}

func (v NullableGetTftpGroups200Response) Get() *GetTftpGroups200Response {
	return v.value
}

func (v *NullableGetTftpGroups200Response) Set(val *GetTftpGroups200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTftpGroups200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTftpGroups200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTftpGroups200Response(val *GetTftpGroups200Response) *NullableGetTftpGroups200Response {
	return &NullableGetTftpGroups200Response{value: val, isSet: true}
}

func (v NullableGetTftpGroups200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTftpGroups200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
