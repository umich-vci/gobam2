...
// checks if the GetTagGroups200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTagGroups200ResponseDataInner{}

// GetTagGroups200ResponseDataInner struct for GetTagGroups200ResponseDataInner
type GetTagGroups200ResponseDataInner struct {
...
func NewGetTagGroups200ResponseDataInner() *GetTagGroups200ResponseDataInner {
	this := GetTagGroups200ResponseDataInner{}
	return &this
}
...
func (o GetTagGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTagGroups200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTagGroups200ResponseDataInner struct {
	value *GetTagGroups200ResponseDataInner
	isSet bool
}

func (v NullableGetTagGroups200ResponseDataInner) Get() *GetTagGroups200ResponseDataInner {
	return v.value
}

func (v *NullableGetTagGroups200ResponseDataInner) Set(val *GetTagGroups200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTagGroups200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTagGroups200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTagGroups200ResponseDataInner(val *GetTagGroups200ResponseDataInner) *NullableGetTagGroups200ResponseDataInner {
	return &NullableGetTagGroups200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetTagGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTagGroups200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
