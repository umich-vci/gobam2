...
// checks if the DNSSECSigningPolicyPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DNSSECSigningPolicyPutRequestBody{}

// DNSSECSigningPolicyPutRequestBody struct for DNSSECSigningPolicyPutRequestBody
type DNSSECSigningPolicyPutRequestBody struct {
...
type _DNSSECSigningPolicyPutRequestBody DNSSECSigningPolicyPutRequestBody
...
func NewDNSSECSigningPolicyPutRequestBody(name string, keyProvider string, signatureDigestAlgorithm string, signatureValidityPeriod string, signatureResigningPeriod string, zoneSigningKeyAlgorithm string, zoneSigningKeyLength int32, zoneSigningKeyValidityPeriod string, zoneSigningKeyOverlapPeriod string, zoneSigningKeyRolloverMethod string, keySigningKeyAlgorithm string, keySigningKeyLength int32, keySigningKeyValidityPeriod string, keySigningKeyOverlapPeriod string, keySigningKeyRolloverMethod string) *DNSSECSigningPolicyPutRequestBody {
	this := DNSSECSigningPolicyPutRequestBody{}
	this.Name = name
...
func (o DNSSECSigningPolicyPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DNSSECSigningPolicyPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *DNSSECSigningPolicyPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varDNSSECSigningPolicyPutRequestBody := _DNSSECSigningPolicyPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDNSSECSigningPolicyPutRequestBody)

	if err != nil {
		return err
	}

	*o = DNSSECSigningPolicyPutRequestBody(varDNSSECSigningPolicyPutRequestBody)

	return err
}

type NullableDNSSECSigningPolicyPutRequestBody struct {
	value *DNSSECSigningPolicyPutRequestBody
	isSet bool
}

func (v NullableDNSSECSigningPolicyPutRequestBody) Get() *DNSSECSigningPolicyPutRequestBody {
	return v.value
}

func (v *NullableDNSSECSigningPolicyPutRequestBody) Set(val *DNSSECSigningPolicyPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSSECSigningPolicyPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSSECSigningPolicyPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSSECSigningPolicyPutRequestBody(val *DNSSECSigningPolicyPutRequestBody) *NullableDNSSECSigningPolicyPutRequestBody {
	return &NullableDNSSECSigningPolicyPutRequestBody{value: val, isSet: true}
}

func (v NullableDNSSECSigningPolicyPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDNSSECSigningPolicyPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
