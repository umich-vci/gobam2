...
// checks if the GetLocationAnnotatedResources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLocationAnnotatedResources200Response{}

// GetLocationAnnotatedResources200Response struct for GetLocationAnnotatedResources200Response
type GetLocationAnnotatedResources200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetLocationAnnotatedResources200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetLocationAnnotatedResources200Response() *GetLocationAnnotatedResources200Response {
	this := GetLocationAnnotatedResources200Response{}
	return &this
}
...
func (o *GetLocationAnnotatedResources200Response) GetData() []GetLocationAnnotatedResources200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLocationAnnotatedResources200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLocationAnnotatedResources200ResponseDataInner and assigns it to the Data field.
func (o *GetLocationAnnotatedResources200Response) SetData(v []GetLocationAnnotatedResources200ResponseDataInner) {
	o.Data = v
}

func (o GetLocationAnnotatedResources200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLocationAnnotatedResources200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLocationAnnotatedResources200Response struct {
	value *GetLocationAnnotatedResources200Response
	isSet bool
}

func (v NullableGetLocationAnnotatedResources200Response) Get() *GetLocationAnnotatedResources200Response {
	return v.value
}

func (v *NullableGetLocationAnnotatedResources200Response) Set(val *GetLocationAnnotatedResources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLocationAnnotatedResources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLocationAnnotatedResources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLocationAnnotatedResources200Response(val *GetLocationAnnotatedResources200Response) *NullableGetLocationAnnotatedResources200Response {
	return &NullableGetLocationAnnotatedResources200Response{value: val, isSet: true}
}

func (v NullableGetLocationAnnotatedResources200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLocationAnnotatedResources200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
