...
// checks if the GetUserTasks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserTasks200Response{}

// GetUserTasks200Response struct for GetUserTasks200Response
type GetUserTasks200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetUserTasks200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetUserTasks200Response) GetData() []GetUserTasks200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetUserTasks200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetUserTasks200ResponseDataInner and assigns it to the Data field.
func (o *GetUserTasks200Response) SetData(v []GetUserTasks200ResponseDataInner) {
	o.Data = v
}

func (o GetUserTasks200Response) MarshalJSON() ([]byte, error) {
...
func (o GetUserTasks200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetUserTasks200Response struct {
	value *GetUserTasks200Response
	isSet bool
}

func (v NullableGetUserTasks200Response) Get() *GetUserTasks200Response {
	return v.value
}

func (v *NullableGetUserTasks200Response) Set(val *GetUserTasks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserTasks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserTasks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserTasks200Response(val *GetUserTasks200Response) *NullableGetUserTasks200Response {
	return &NullableGetUserTasks200Response{value: val, isSet: true}
}

func (v NullableGetUserTasks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserTasks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
