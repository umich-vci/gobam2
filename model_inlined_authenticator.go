...
// checks if the InlinedAuthenticator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedAuthenticator{}

// InlinedAuthenticator struct for InlinedAuthenticator
...
func (o InlinedAuthenticator) MarshalJSON() ([]byte, error) {
...
func (o InlinedAuthenticator) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedAuthenticator struct {
	value *InlinedAuthenticator
	isSet bool
}

func (v NullableInlinedAuthenticator) Get() *InlinedAuthenticator {
	return v.value
}

func (v *NullableInlinedAuthenticator) Set(val *InlinedAuthenticator) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedAuthenticator) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedAuthenticator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedAuthenticator(val *InlinedAuthenticator) *NullableInlinedAuthenticator {
	return &NullableInlinedAuthenticator{value: val, isSet: true}
}

func (v NullableInlinedAuthenticator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedAuthenticator) UnmarshalJSON(src []byte) error {
	v.isSet = true
