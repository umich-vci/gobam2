...
// checks if the InlinedZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedZone{}

// InlinedZone struct for InlinedZone
type InlinedZone struct {
...
func (o InlinedZone) MarshalJSON() ([]byte, error) {
...
func (o InlinedZone) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedZone struct {
	value *InlinedZone
	isSet bool
}

func (v NullableInlinedZone) Get() *InlinedZone {
	return v.value
}

func (v *NullableInlinedZone) Set(val *InlinedZone) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedZone) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedZone(val *InlinedZone) *NullableInlinedZone {
	return &NullableInlinedZone{value: val, isSet: true}
}

func (v NullableInlinedZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
