...
type ResourceLinks struct {
	Self *ResourceLinksSelf `json:"self,omitempty"`
...
// SetSelf gets a reference to the given ResourceLinksSelf and assigns it to the Self field.
...
func (o *ResourceLinks) UnmarshalJSON(data []byte) (err error) {
	varResourceLinks := _ResourceLinks{}

	err = json.Unmarshal(data, &varResourceLinks)
