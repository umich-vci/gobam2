...
// checks if the GetCollectionTemplates200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionTemplates200Response{}

// GetCollectionTemplates200Response struct for GetCollectionTemplates200Response
type GetCollectionTemplates200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionTemplates200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionTemplates200Response() *GetCollectionTemplates200Response {
	this := GetCollectionTemplates200Response{}
	return &this
}
...
func (o *GetCollectionTemplates200Response) GetData() []GetCollectionTemplates200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionTemplates200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionTemplates200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionTemplates200Response) SetData(v []GetCollectionTemplates200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionTemplates200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionTemplates200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionTemplates200Response struct {
	value *GetCollectionTemplates200Response
	isSet bool
}

func (v NullableGetCollectionTemplates200Response) Get() *GetCollectionTemplates200Response {
	return v.value
}

func (v *NullableGetCollectionTemplates200Response) Set(val *GetCollectionTemplates200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionTemplates200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionTemplates200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionTemplates200Response(val *GetCollectionTemplates200Response) *NullableGetCollectionTemplates200Response {
	return &NullableGetCollectionTemplates200Response{value: val, isSet: true}
}

func (v NullableGetCollectionTemplates200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionTemplates200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
