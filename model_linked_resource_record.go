...
// checks if the LinkedResourceRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkedResourceRecord{}

// LinkedResourceRecord The host or alias record to which the resource record is linked.
type LinkedResourceRecord struct {
...
func (o LinkedResourceRecord) MarshalJSON() ([]byte, error) {
...
func (o LinkedResourceRecord) ToMap() (map[string]interface{}, error) {
...
type NullableLinkedResourceRecord struct {
	value *LinkedResourceRecord
	isSet bool
}

func (v NullableLinkedResourceRecord) Get() *LinkedResourceRecord {
	return v.value
}

func (v *NullableLinkedResourceRecord) Set(val *LinkedResourceRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkedResourceRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkedResourceRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkedResourceRecord(val *LinkedResourceRecord) *NullableLinkedResourceRecord {
	return &NullableLinkedResourceRecord{value: val, isSet: true}
}

func (v NullableLinkedResourceRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkedResourceRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
