...
// checks if the ZoneTemplatePutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneTemplatePutRequestBody{}

// ZoneTemplatePutRequestBody struct for ZoneTemplatePutRequestBody
type ZoneTemplatePutRequestBody struct {
...
type _ZoneTemplatePutRequestBody ZoneTemplatePutRequestBody
...
func NewZoneTemplatePutRequestBody(type_ string, name string) *ZoneTemplatePutRequestBody {
	this := ZoneTemplatePutRequestBody{}
	this.Type = type_
	this.Name = name
	return &this
}
...
func (o ZoneTemplatePutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o ZoneTemplatePutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneTemplatePutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varZoneTemplatePutRequestBody := _ZoneTemplatePutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZoneTemplatePutRequestBody)

	if err != nil {
		return err
	}

	*o = ZoneTemplatePutRequestBody(varZoneTemplatePutRequestBody)

	return err
}

type NullableZoneTemplatePutRequestBody struct {
	value *ZoneTemplatePutRequestBody
	isSet bool
}

func (v NullableZoneTemplatePutRequestBody) Get() *ZoneTemplatePutRequestBody {
	return v.value
}

func (v *NullableZoneTemplatePutRequestBody) Set(val *ZoneTemplatePutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneTemplatePutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneTemplatePutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneTemplatePutRequestBody(val *ZoneTemplatePutRequestBody) *NullableZoneTemplatePutRequestBody {
	return &NullableZoneTemplatePutRequestBody{value: val, isSet: true}
}

func (v NullableZoneTemplatePutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneTemplatePutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
