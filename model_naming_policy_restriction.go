...
// checks if the NamingPolicyRestriction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamingPolicyRestriction{}

// NamingPolicyRestriction struct for NamingPolicyRestriction
type NamingPolicyRestriction struct {
...
func (o NamingPolicyRestriction) MarshalJSON() ([]byte, error) {
...
func (o NamingPolicyRestriction) ToMap() (map[string]interface{}, error) {
...
type NullableNamingPolicyRestriction struct {
	value *NamingPolicyRestriction
	isSet bool
}

func (v NullableNamingPolicyRestriction) Get() *NamingPolicyRestriction {
	return v.value
}

func (v *NullableNamingPolicyRestriction) Set(val *NamingPolicyRestriction) {
	v.value = val
	v.isSet = true
}

func (v NullableNamingPolicyRestriction) IsSet() bool {
	return v.isSet
}

func (v *NullableNamingPolicyRestriction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamingPolicyRestriction(val *NamingPolicyRestriction) *NullableNamingPolicyRestriction {
	return &NullableNamingPolicyRestriction{value: val, isSet: true}
}

func (v NullableNamingPolicyRestriction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamingPolicyRestriction) UnmarshalJSON(src []byte) error {
	v.isSet = true
