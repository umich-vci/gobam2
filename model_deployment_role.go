...
// checks if the DeploymentRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentRole{}

// DeploymentRole struct for DeploymentRole
...
func (o DeploymentRole) MarshalJSON() ([]byte, error) {
...
func (o DeploymentRole) ToMap() (map[string]interface{}, error) {
