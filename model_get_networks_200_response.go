...
// checks if the GetNetworks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworks200Response{}

// GetNetworks200Response struct for GetNetworks200Response
type GetNetworks200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetNetworks200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetNetworks200Response) GetData() []GetNetworks200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetNetworks200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetNetworks200ResponseDataInner and assigns it to the Data field.
func (o *GetNetworks200Response) SetData(v []GetNetworks200ResponseDataInner) {
	o.Data = v
}

func (o GetNetworks200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNetworks200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworks200Response struct {
	value *GetNetworks200Response
	isSet bool
}

func (v NullableGetNetworks200Response) Get() *GetNetworks200Response {
	return v.value
}

func (v *NullableGetNetworks200Response) Set(val *GetNetworks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworks200Response(val *GetNetworks200Response) *NullableGetNetworks200Response {
	return &NullableGetNetworks200Response{value: val, isSet: true}
}

func (v NullableGetNetworks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
