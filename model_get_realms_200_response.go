...
// checks if the GetRealms200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRealms200Response{}

// GetRealms200Response struct for GetRealms200Response
type GetRealms200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetRealms200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetRealms200Response) GetData() []GetRealms200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetRealms200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetRealms200ResponseDataInner and assigns it to the Data field.
func (o *GetRealms200Response) SetData(v []GetRealms200ResponseDataInner) {
	o.Data = v
}

func (o GetRealms200Response) MarshalJSON() ([]byte, error) {
...
func (o GetRealms200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetRealms200Response struct {
	value *GetRealms200Response
	isSet bool
}

func (v NullableGetRealms200Response) Get() *GetRealms200Response {
	return v.value
}

func (v *NullableGetRealms200Response) Set(val *GetRealms200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRealms200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRealms200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRealms200Response(val *GetRealms200Response) *NullableGetRealms200Response {
	return &NullableGetRealms200Response{value: val, isSet: true}
}

func (v NullableGetRealms200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRealms200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
