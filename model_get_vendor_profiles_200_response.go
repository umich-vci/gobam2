...
// checks if the GetVendorProfiles200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVendorProfiles200Response{}

// GetVendorProfiles200Response struct for GetVendorProfiles200Response
type GetVendorProfiles200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetVendorProfiles200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetVendorProfiles200Response() *GetVendorProfiles200Response {
	this := GetVendorProfiles200Response{}
	return &this
}
...
func (o *GetVendorProfiles200Response) GetData() []GetVendorProfiles200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetVendorProfiles200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetVendorProfiles200ResponseDataInner and assigns it to the Data field.
func (o *GetVendorProfiles200Response) SetData(v []GetVendorProfiles200ResponseDataInner) {
	o.Data = v
}

func (o GetVendorProfiles200Response) MarshalJSON() ([]byte, error) {
...
func (o GetVendorProfiles200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetVendorProfiles200Response struct {
	value *GetVendorProfiles200Response
	isSet bool
}

func (v NullableGetVendorProfiles200Response) Get() *GetVendorProfiles200Response {
	return v.value
}

func (v *NullableGetVendorProfiles200Response) Set(val *GetVendorProfiles200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVendorProfiles200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVendorProfiles200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVendorProfiles200Response(val *GetVendorProfiles200Response) *NullableGetVendorProfiles200Response {
	return &NullableGetVendorProfiles200Response{value: val, isSet: true}
}

func (v NullableGetVendorProfiles200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVendorProfiles200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
