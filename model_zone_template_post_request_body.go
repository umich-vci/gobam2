...
// checks if the ZoneTemplatePostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneTemplatePostRequestBody{}

// ZoneTemplatePostRequestBody struct for ZoneTemplatePostRequestBody
type ZoneTemplatePostRequestBody struct {
...
type _ZoneTemplatePostRequestBody ZoneTemplatePostRequestBody
...
func NewZoneTemplatePostRequestBody(type_ string, name string) *ZoneTemplatePostRequestBody {
	this := ZoneTemplatePostRequestBody{}
	this.Type = type_
	this.Name = name
	return &this
}
...
func (o ZoneTemplatePostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o ZoneTemplatePostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *ZoneTemplatePostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varZoneTemplatePostRequestBody := _ZoneTemplatePostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZoneTemplatePostRequestBody)

	if err != nil {
		return err
	}

	*o = ZoneTemplatePostRequestBody(varZoneTemplatePostRequestBody)

	return err
}

type NullableZoneTemplatePostRequestBody struct {
	value *ZoneTemplatePostRequestBody
	isSet bool
}

func (v NullableZoneTemplatePostRequestBody) Get() *ZoneTemplatePostRequestBody {
	return v.value
}

func (v *NullableZoneTemplatePostRequestBody) Set(val *ZoneTemplatePostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneTemplatePostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneTemplatePostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneTemplatePostRequestBody(val *ZoneTemplatePostRequestBody) *NullableZoneTemplatePostRequestBody {
	return &NullableZoneTemplatePostRequestBody{value: val, isSet: true}
}

func (v NullableZoneTemplatePostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneTemplatePostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
