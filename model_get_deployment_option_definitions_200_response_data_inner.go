...
// checks if the GetDeploymentOptionDefinitions200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeploymentOptionDefinitions200ResponseDataInner{}

// GetDeploymentOptionDefinitions200ResponseDataInner struct for GetDeploymentOptionDefinitions200ResponseDataInner
type GetDeploymentOptionDefinitions200ResponseDataInner struct {
...
func NewGetDeploymentOptionDefinitions200ResponseDataInner() *GetDeploymentOptionDefinitions200ResponseDataInner {
	this := GetDeploymentOptionDefinitions200ResponseDataInner{}
	return &this
}
...
func (o GetDeploymentOptionDefinitions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetDeploymentOptionDefinitions200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeploymentOptionDefinitions200ResponseDataInner struct {
	value *GetDeploymentOptionDefinitions200ResponseDataInner
	isSet bool
}

func (v NullableGetDeploymentOptionDefinitions200ResponseDataInner) Get() *GetDeploymentOptionDefinitions200ResponseDataInner {
	return v.value
}

func (v *NullableGetDeploymentOptionDefinitions200ResponseDataInner) Set(val *GetDeploymentOptionDefinitions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeploymentOptionDefinitions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeploymentOptionDefinitions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeploymentOptionDefinitions200ResponseDataInner(val *GetDeploymentOptionDefinitions200ResponseDataInner) *NullableGetDeploymentOptionDefinitions200ResponseDataInner {
	return &NullableGetDeploymentOptionDefinitions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetDeploymentOptionDefinitions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeploymentOptionDefinitions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
