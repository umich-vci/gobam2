...
// checks if the GetDeviceSubtypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceSubtypes200Response{}

// GetDeviceSubtypes200Response struct for GetDeviceSubtypes200Response
type GetDeviceSubtypes200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDeviceSubtypes200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDeviceSubtypes200Response() *GetDeviceSubtypes200Response {
	this := GetDeviceSubtypes200Response{}
	return &this
}
...
func (o *GetDeviceSubtypes200Response) GetData() []GetDeviceSubtypes200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDeviceSubtypes200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDeviceSubtypes200ResponseDataInner and assigns it to the Data field.
func (o *GetDeviceSubtypes200Response) SetData(v []GetDeviceSubtypes200ResponseDataInner) {
	o.Data = v
}

func (o GetDeviceSubtypes200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceSubtypes200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeviceSubtypes200Response struct {
	value *GetDeviceSubtypes200Response
	isSet bool
}

func (v NullableGetDeviceSubtypes200Response) Get() *GetDeviceSubtypes200Response {
	return v.value
}

func (v *NullableGetDeviceSubtypes200Response) Set(val *GetDeviceSubtypes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceSubtypes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceSubtypes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceSubtypes200Response(val *GetDeviceSubtypes200Response) *NullableGetDeviceSubtypes200Response {
	return &NullableGetDeviceSubtypes200Response{value: val, isSet: true}
}

func (v NullableGetDeviceSubtypes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceSubtypes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
