...
// checks if the DeviceSubtypePutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceSubtypePutRequestBody{}

// DeviceSubtypePutRequestBody struct for DeviceSubtypePutRequestBody
type DeviceSubtypePutRequestBody struct {
...
type _DeviceSubtypePutRequestBody DeviceSubtypePutRequestBody
...
func NewDeviceSubtypePutRequestBody(name string) *DeviceSubtypePutRequestBody {
	this := DeviceSubtypePutRequestBody{}
	this.Name = name
	return &this
}
...
func (o DeviceSubtypePutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DeviceSubtypePutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceSubtypePutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceSubtypePutRequestBody := _DeviceSubtypePutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceSubtypePutRequestBody)

	if err != nil {
		return err
	}

	*o = DeviceSubtypePutRequestBody(varDeviceSubtypePutRequestBody)

	return err
}

type NullableDeviceSubtypePutRequestBody struct {
	value *DeviceSubtypePutRequestBody
	isSet bool
}

func (v NullableDeviceSubtypePutRequestBody) Get() *DeviceSubtypePutRequestBody {
	return v.value
}

func (v *NullableDeviceSubtypePutRequestBody) Set(val *DeviceSubtypePutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceSubtypePutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceSubtypePutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceSubtypePutRequestBody(val *DeviceSubtypePutRequestBody) *NullableDeviceSubtypePutRequestBody {
	return &NullableDeviceSubtypePutRequestBody{value: val, isSet: true}
}

func (v NullableDeviceSubtypePutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceSubtypePutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
