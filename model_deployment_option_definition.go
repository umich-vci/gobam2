...
// checks if the DeploymentOptionDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentOptionDefinition{}

// DeploymentOptionDefinition struct for DeploymentOptionDefinition
type DeploymentOptionDefinition struct {
...
func NewDeploymentOptionDefinition() *DeploymentOptionDefinition {
	this := DeploymentOptionDefinition{}
	return &this
}
...
func (o DeploymentOptionDefinition) MarshalJSON() ([]byte, error) {
...
func (o DeploymentOptionDefinition) ToMap() (map[string]interface{}, error) {
...
type NullableDeploymentOptionDefinition struct {
	value *DeploymentOptionDefinition
	isSet bool
}

func (v NullableDeploymentOptionDefinition) Get() *DeploymentOptionDefinition {
	return v.value
}

func (v *NullableDeploymentOptionDefinition) Set(val *DeploymentOptionDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentOptionDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentOptionDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentOptionDefinition(val *DeploymentOptionDefinition) *NullableDeploymentOptionDefinition {
	return &NullableDeploymentOptionDefinition{value: val, isSet: true}
}

func (v NullableDeploymentOptionDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentOptionDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
