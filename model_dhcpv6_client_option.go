...
// checks if the DHCPv6ClientOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPv6ClientOption{}

// DHCPv6ClientOption struct for DHCPv6ClientOption
type DHCPv6ClientOption struct {
	DeploymentOption
	// The resource type.
	...
	Definition *InlinedDHCPv6ClientOptionDefinition `json:"definition,omitempty"`
}
...
func (o *DHCPv6ClientOption) GetDefinition() InlinedDHCPv6ClientOptionDefinition {
	if o == nil || IsNil(o.Definition) {
		var ret InlinedDHCPv6ClientOptionDefinition
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given InlinedDHCPv6ClientOptionDefinition and assigns it to the Definition field.
func (o *DHCPv6ClientOption) SetDefinition(v InlinedDHCPv6ClientOptionDefinition) {
	o.Definition = &v
}

func (o DHCPv6ClientOption) MarshalJSON() ([]byte, error) {
...
func (o DHCPv6ClientOption) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPv6ClientOption struct {
	value *DHCPv6ClientOption
	isSet bool
}

func (v NullableDHCPv6ClientOption) Get() *DHCPv6ClientOption {
	return v.value
}

func (v *NullableDHCPv6ClientOption) Set(val *DHCPv6ClientOption) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPv6ClientOption) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPv6ClientOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPv6ClientOption(val *DHCPv6ClientOption) *NullableDHCPv6ClientOption {
	return &NullableDHCPv6ClientOption{value: val, isSet: true}
}

func (v NullableDHCPv6ClientOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPv6ClientOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
