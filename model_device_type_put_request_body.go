...
// checks if the DeviceTypePutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceTypePutRequestBody{}

// DeviceTypePutRequestBody struct for DeviceTypePutRequestBody
type DeviceTypePutRequestBody struct {
...
type _DeviceTypePutRequestBody DeviceTypePutRequestBody
...
func (o DeviceTypePutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DeviceTypePutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceTypePutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceTypePutRequestBody := _DeviceTypePutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceTypePutRequestBody)

	if err != nil {
		return err
	}

	*o = DeviceTypePutRequestBody(varDeviceTypePutRequestBody)

	return err
}

type NullableDeviceTypePutRequestBody struct {
	value *DeviceTypePutRequestBody
	isSet bool
}

func (v NullableDeviceTypePutRequestBody) Get() *DeviceTypePutRequestBody {
	return v.value
}

func (v *NullableDeviceTypePutRequestBody) Set(val *DeviceTypePutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceTypePutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceTypePutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceTypePutRequestBody(val *DeviceTypePutRequestBody) *NullableDeviceTypePutRequestBody {
	return &NullableDeviceTypePutRequestBody{value: val, isSet: true}
}

func (v NullableDeviceTypePutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceTypePutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
