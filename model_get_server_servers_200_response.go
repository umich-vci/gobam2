...
// checks if the GetServerServers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerServers200Response{}

// GetServerServers200Response struct for GetServerServers200Response
type GetServerServers200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetServerServers200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetServerServers200Response() *GetServerServers200Response {
	this := GetServerServers200Response{}
	return &this
}
...
func (o *GetServerServers200Response) GetData() []GetServerServers200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetServerServers200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetServerServers200ResponseDataInner and assigns it to the Data field.
func (o *GetServerServers200Response) SetData(v []GetServerServers200ResponseDataInner) {
	o.Data = v
}

func (o GetServerServers200Response) MarshalJSON() ([]byte, error) {
...
func (o GetServerServers200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerServers200Response struct {
	value *GetServerServers200Response
	isSet bool
}

func (v NullableGetServerServers200Response) Get() *GetServerServers200Response {
	return v.value
}

func (v *NullableGetServerServers200Response) Set(val *GetServerServers200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerServers200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerServers200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerServers200Response(val *GetServerServers200Response) *NullableGetServerServers200Response {
	return &NullableGetServerServers200Response{value: val, isSet: true}
}

func (v NullableGetServerServers200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerServers200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
