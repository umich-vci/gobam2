...
// checks if the GetSessions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSessions200Response{}

// GetSessions200Response struct for GetSessions200Response
type GetSessions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetSessions200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetSessions200Response) GetData() []GetSessions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetSessions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetSessions200ResponseDataInner and assigns it to the Data field.
func (o *GetSessions200Response) SetData(v []GetSessions200ResponseDataInner) {
	o.Data = v
}

func (o GetSessions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSessions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSessions200Response struct {
	value *GetSessions200Response
	isSet bool
}

func (v NullableGetSessions200Response) Get() *GetSessions200Response {
	return v.value
}

func (v *NullableGetSessions200Response) Set(val *GetSessions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSessions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSessions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSessions200Response(val *GetSessions200Response) *NullableGetSessions200Response {
	return &NullableGetSessions200Response{value: val, isSet: true}
}

func (v NullableGetSessions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSessions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
