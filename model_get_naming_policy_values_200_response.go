...
// checks if the GetNamingPolicyValues200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNamingPolicyValues200Response{}

// GetNamingPolicyValues200Response struct for GetNamingPolicyValues200Response
type GetNamingPolicyValues200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetNamingPolicyValues200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetNamingPolicyValues200Response() *GetNamingPolicyValues200Response {
	this := GetNamingPolicyValues200Response{}
	return &this
}
...
func (o *GetNamingPolicyValues200Response) GetData() []GetNamingPolicyValues200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetNamingPolicyValues200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetNamingPolicyValues200ResponseDataInner and assigns it to the Data field.
func (o *GetNamingPolicyValues200Response) SetData(v []GetNamingPolicyValues200ResponseDataInner) {
	o.Data = v
}

func (o GetNamingPolicyValues200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNamingPolicyValues200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNamingPolicyValues200Response struct {
	value *GetNamingPolicyValues200Response
	isSet bool
}

func (v NullableGetNamingPolicyValues200Response) Get() *GetNamingPolicyValues200Response {
	return v.value
}

func (v *NullableGetNamingPolicyValues200Response) Set(val *GetNamingPolicyValues200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNamingPolicyValues200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNamingPolicyValues200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNamingPolicyValues200Response(val *GetNamingPolicyValues200Response) *NullableGetNamingPolicyValues200Response {
	return &NullableGetNamingPolicyValues200Response{value: val, isSet: true}
}

func (v NullableGetNamingPolicyValues200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNamingPolicyValues200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
