...
// checks if the GetReconciliationPolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetReconciliationPolicies200Response{}

// GetReconciliationPolicies200Response struct for GetReconciliationPolicies200Response
type GetReconciliationPolicies200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetReconciliationPolicies200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetReconciliationPolicies200Response() *GetReconciliationPolicies200Response {
	this := GetReconciliationPolicies200Response{}
	return &this
}
...
func (o *GetReconciliationPolicies200Response) GetData() []GetReconciliationPolicies200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetReconciliationPolicies200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetReconciliationPolicies200ResponseDataInner and assigns it to the Data field.
func (o *GetReconciliationPolicies200Response) SetData(v []GetReconciliationPolicies200ResponseDataInner) {
	o.Data = v
}

func (o GetReconciliationPolicies200Response) MarshalJSON() ([]byte, error) {
...
func (o GetReconciliationPolicies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetReconciliationPolicies200Response struct {
	value *GetReconciliationPolicies200Response
	isSet bool
}

func (v NullableGetReconciliationPolicies200Response) Get() *GetReconciliationPolicies200Response {
	return v.value
}

func (v *NullableGetReconciliationPolicies200Response) Set(val *GetReconciliationPolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetReconciliationPolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetReconciliationPolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetReconciliationPolicies200Response(val *GetReconciliationPolicies200Response) *NullableGetReconciliationPolicies200Response {
	return &NullableGetReconciliationPolicies200Response{value: val, isSet: true}
}

func (v NullableGetReconciliationPolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetReconciliationPolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
