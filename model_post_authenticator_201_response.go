...
// checks if the PostAuthenticator201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostAuthenticator201Response{}

// PostAuthenticator201Response struct for PostAuthenticator201Response
type PostAuthenticator201Response struct {
...
func NewPostAuthenticator201Response() *PostAuthenticator201Response {
	this := PostAuthenticator201Response{}
	return &this
}
...
func (o PostAuthenticator201Response) MarshalJSON() ([]byte, error) {
...
func (o PostAuthenticator201Response) ToMap() (map[string]interface{}, error) {
...
type NullablePostAuthenticator201Response struct {
	value *PostAuthenticator201Response
	isSet bool
}

func (v NullablePostAuthenticator201Response) Get() *PostAuthenticator201Response {
	return v.value
}

func (v *NullablePostAuthenticator201Response) Set(val *PostAuthenticator201Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePostAuthenticator201Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePostAuthenticator201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostAuthenticator201Response(val *PostAuthenticator201Response) *NullablePostAuthenticator201Response {
	return &NullablePostAuthenticator201Response{value: val, isSet: true}
}

func (v NullablePostAuthenticator201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostAuthenticator201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
