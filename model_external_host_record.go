...
// checks if the ExternalHostRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalHostRecord{}

// ExternalHostRecord struct for ExternalHostRecord
...
func (o ExternalHostRecord) MarshalJSON() ([]byte, error) {
...
func (o ExternalHostRecord) ToMap() (map[string]interface{}, error) {
...
type NullableExternalHostRecord struct {
	value *ExternalHostRecord
	isSet bool
}

func (v NullableExternalHostRecord) Get() *ExternalHostRecord {
	return v.value
}

func (v *NullableExternalHostRecord) Set(val *ExternalHostRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalHostRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalHostRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalHostRecord(val *ExternalHostRecord) *NullableExternalHostRecord {
	return &NullableExternalHostRecord{value: val, isSet: true}
}

func (v NullableExternalHostRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalHostRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
