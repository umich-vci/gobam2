...
// checks if the GetPolicyItems200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPolicyItems200Response{}

// GetPolicyItems200Response struct for GetPolicyItems200Response
type GetPolicyItems200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetPolicyItems200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetPolicyItems200Response() *GetPolicyItems200Response {
	this := GetPolicyItems200Response{}
	return &this
}
...
func (o *GetPolicyItems200Response) GetData() []GetPolicyItems200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetPolicyItems200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetPolicyItems200ResponseDataInner and assigns it to the Data field.
func (o *GetPolicyItems200Response) SetData(v []GetPolicyItems200ResponseDataInner) {
	o.Data = v
}

func (o GetPolicyItems200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPolicyItems200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetPolicyItems200Response struct {
	value *GetPolicyItems200Response
	isSet bool
}

func (v NullableGetPolicyItems200Response) Get() *GetPolicyItems200Response {
	return v.value
}

func (v *NullableGetPolicyItems200Response) Set(val *GetPolicyItems200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPolicyItems200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPolicyItems200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPolicyItems200Response(val *GetPolicyItems200Response) *NullableGetPolicyItems200Response {
	return &NullableGetPolicyItems200Response{value: val, isSet: true}
}

func (v NullableGetPolicyItems200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPolicyItems200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
