...
// checks if the GetAccessControlLists200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccessControlLists200Response{}

// GetAccessControlLists200Response struct for GetAccessControlLists200Response
type GetAccessControlLists200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetAccessControlLists200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetAccessControlLists200Response() *GetAccessControlLists200Response {
	this := GetAccessControlLists200Response{}
	return &this
}
...
func (o *GetAccessControlLists200Response) GetData() []GetAccessControlLists200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetAccessControlLists200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetAccessControlLists200ResponseDataInner and assigns it to the Data field.
func (o *GetAccessControlLists200Response) SetData(v []GetAccessControlLists200ResponseDataInner) {
	o.Data = v
}

func (o GetAccessControlLists200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAccessControlLists200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccessControlLists200Response struct {
	value *GetAccessControlLists200Response
	isSet bool
}

func (v NullableGetAccessControlLists200Response) Get() *GetAccessControlLists200Response {
	return v.value
}

func (v *NullableGetAccessControlLists200Response) Set(val *GetAccessControlLists200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccessControlLists200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccessControlLists200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccessControlLists200Response(val *GetAccessControlLists200Response) *NullableGetAccessControlLists200Response {
	return &NullableGetAccessControlLists200Response{value: val, isSet: true}
}

func (v NullableGetAccessControlLists200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccessControlLists200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
