...
// checks if the TagPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagPutRequestBody{}

// TagPutRequestBody struct for TagPutRequestBody
type TagPutRequestBody struct {
...
type _TagPutRequestBody TagPutRequestBody
...
func (o TagPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o TagPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *TagPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varTagPutRequestBody := _TagPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTagPutRequestBody)

	if err != nil {
		return err
	}

	*o = TagPutRequestBody(varTagPutRequestBody)

	return err
}

type NullableTagPutRequestBody struct {
	value *TagPutRequestBody
	isSet bool
}

func (v NullableTagPutRequestBody) Get() *TagPutRequestBody {
	return v.value
}

func (v *NullableTagPutRequestBody) Set(val *TagPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableTagPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableTagPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagPutRequestBody(val *TagPutRequestBody) *NullableTagPutRequestBody {
	return &NullableTagPutRequestBody{value: val, isSet: true}
}

func (v NullableTagPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
