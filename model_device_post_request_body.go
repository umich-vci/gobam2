...
// checks if the DevicePostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DevicePostRequestBody{}

// DevicePostRequestBody struct for DevicePostRequestBody
type DevicePostRequestBody struct {
...
type _DevicePostRequestBody DevicePostRequestBody
...
func (o DevicePostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DevicePostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *DevicePostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varDevicePostRequestBody := _DevicePostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDevicePostRequestBody)

	if err != nil {
		return err
	}

	*o = DevicePostRequestBody(varDevicePostRequestBody)

	return err
}

type NullableDevicePostRequestBody struct {
	value *DevicePostRequestBody
	isSet bool
}

func (v NullableDevicePostRequestBody) Get() *DevicePostRequestBody {
	return v.value
}

func (v *NullableDevicePostRequestBody) Set(val *DevicePostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDevicePostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDevicePostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDevicePostRequestBody(val *DevicePostRequestBody) *NullableDevicePostRequestBody {
	return &NullableDevicePostRequestBody{value: val, isSet: true}
}

func (v NullableDevicePostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDevicePostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
