...
// checks if the DHCPZoneGroupPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPZoneGroupPostRequestBody{}

// DHCPZoneGroupPostRequestBody struct for DHCPZoneGroupPostRequestBody
type DHCPZoneGroupPostRequestBody struct {
	// The resource identifier.
	Id *int64 `json:"id,omitempty"`
	// The resource type.
	Type *string `json:"type,omitempty"`
	// The name of the DHCP zone group.
...
type _DHCPZoneGroupPostRequestBody DHCPZoneGroupPostRequestBody
...
func NewDHCPZoneGroupPostRequestBody(name string) *DHCPZoneGroupPostRequestBody {
	this := DHCPZoneGroupPostRequestBody{}
	this.Name = name
	return &this
}
...
func (o DHCPZoneGroupPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DHCPZoneGroupPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *DHCPZoneGroupPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varDHCPZoneGroupPostRequestBody := _DHCPZoneGroupPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDHCPZoneGroupPostRequestBody)

	if err != nil {
		return err
	}

	*o = DHCPZoneGroupPostRequestBody(varDHCPZoneGroupPostRequestBody)

	return err
}

type NullableDHCPZoneGroupPostRequestBody struct {
	value *DHCPZoneGroupPostRequestBody
	isSet bool
}

func (v NullableDHCPZoneGroupPostRequestBody) Get() *DHCPZoneGroupPostRequestBody {
	return v.value
}

func (v *NullableDHCPZoneGroupPostRequestBody) Set(val *DHCPZoneGroupPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPZoneGroupPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPZoneGroupPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPZoneGroupPostRequestBody(val *DHCPZoneGroupPostRequestBody) *NullableDHCPZoneGroupPostRequestBody {
	return &NullableDHCPZoneGroupPostRequestBody{value: val, isSet: true}
}

func (v NullableDHCPZoneGroupPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPZoneGroupPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
