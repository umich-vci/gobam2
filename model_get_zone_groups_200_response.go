...
// checks if the GetZoneGroups200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneGroups200Response{}

// GetZoneGroups200Response struct for GetZoneGroups200Response
type GetZoneGroups200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetZoneGroups200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetZoneGroups200Response) GetData() []GetZoneGroups200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetZoneGroups200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetZoneGroups200ResponseDataInner and assigns it to the Data field.
func (o *GetZoneGroups200Response) SetData(v []GetZoneGroups200ResponseDataInner) {
	o.Data = v
}

func (o GetZoneGroups200Response) MarshalJSON() ([]byte, error) {
...
func (o GetZoneGroups200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetZoneGroups200Response struct {
	value *GetZoneGroups200Response
	isSet bool
}

func (v NullableGetZoneGroups200Response) Get() *GetZoneGroups200Response {
	return v.value
}

func (v *NullableGetZoneGroups200Response) Set(val *GetZoneGroups200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneGroups200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneGroups200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneGroups200Response(val *GetZoneGroups200Response) *NullableGetZoneGroups200Response {
	return &NullableGetZoneGroups200Response{value: val, isSet: true}
}

func (v NullableGetZoneGroups200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneGroups200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
