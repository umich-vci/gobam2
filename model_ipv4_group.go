...
// checks if the IPv4Group type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPv4Group{}

// IPv4Group struct for IPv4Group
type IPv4Group struct {
...
func (o IPv4Group) MarshalJSON() ([]byte, error) {
...
func (o IPv4Group) ToMap() (map[string]interface{}, error) {
...
type NullableIPv4Group struct {
	value *IPv4Group
	isSet bool
}

func (v NullableIPv4Group) Get() *IPv4Group {
	return v.value
}

func (v *NullableIPv4Group) Set(val *IPv4Group) {
	v.value = val
	v.isSet = true
}

func (v NullableIPv4Group) IsSet() bool {
	return v.isSet
}

func (v *NullableIPv4Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPv4Group(val *IPv4Group) *NullableIPv4Group {
	return &NullableIPv4Group{value: val, isSet: true}
}

func (v NullableIPv4Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPv4Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
