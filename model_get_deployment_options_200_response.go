...
// checks if the GetDeploymentOptions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeploymentOptions200Response{}

// GetDeploymentOptions200Response struct for GetDeploymentOptions200Response
type GetDeploymentOptions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDeploymentOptions200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDeploymentOptions200Response() *GetDeploymentOptions200Response {
	this := GetDeploymentOptions200Response{}
	return &this
}
...
func (o *GetDeploymentOptions200Response) GetData() []GetDeploymentOptions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDeploymentOptions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDeploymentOptions200ResponseDataInner and assigns it to the Data field.
func (o *GetDeploymentOptions200Response) SetData(v []GetDeploymentOptions200ResponseDataInner) {
	o.Data = v
}

func (o GetDeploymentOptions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDeploymentOptions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeploymentOptions200Response struct {
	value *GetDeploymentOptions200Response
	isSet bool
}

func (v NullableGetDeploymentOptions200Response) Get() *GetDeploymentOptions200Response {
	return v.value
}

func (v *NullableGetDeploymentOptions200Response) Set(val *GetDeploymentOptions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeploymentOptions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeploymentOptions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeploymentOptions200Response(val *GetDeploymentOptions200Response) *NullableGetDeploymentOptions200Response {
	return &NullableGetDeploymentOptions200Response{value: val, isSet: true}
}

func (v NullableGetDeploymentOptions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeploymentOptions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
