...
// checks if the GetServicePrincipals200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServicePrincipals200Response{}

// GetServicePrincipals200Response struct for GetServicePrincipals200Response
type GetServicePrincipals200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetServicePrincipals200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetServicePrincipals200Response() *GetServicePrincipals200Response {
	this := GetServicePrincipals200Response{}
	return &this
}
...
func (o *GetServicePrincipals200Response) GetData() []GetServicePrincipals200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetServicePrincipals200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetServicePrincipals200ResponseDataInner and assigns it to the Data field.
func (o *GetServicePrincipals200Response) SetData(v []GetServicePrincipals200ResponseDataInner) {
	o.Data = v
}

func (o GetServicePrincipals200Response) MarshalJSON() ([]byte, error) {
...
func (o GetServicePrincipals200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServicePrincipals200Response struct {
	value *GetServicePrincipals200Response
	isSet bool
}

func (v NullableGetServicePrincipals200Response) Get() *GetServicePrincipals200Response {
	return v.value
}

func (v *NullableGetServicePrincipals200Response) Set(val *GetServicePrincipals200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServicePrincipals200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServicePrincipals200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServicePrincipals200Response(val *GetServicePrincipals200Response) *NullableGetServicePrincipals200Response {
	return &NullableGetServicePrincipals200Response{value: val, isSet: true}
}

func (v NullableGetServicePrincipals200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServicePrincipals200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
