...
// checks if the GetWorkflowRequests200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWorkflowRequests200Response{}

// GetWorkflowRequests200Response struct for GetWorkflowRequests200Response
type GetWorkflowRequests200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetWorkflowRequests200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetWorkflowRequests200Response() *GetWorkflowRequests200Response {
	this := GetWorkflowRequests200Response{}
	return &this
}
...
func (o *GetWorkflowRequests200Response) GetData() []GetWorkflowRequests200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetWorkflowRequests200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetWorkflowRequests200ResponseDataInner and assigns it to the Data field.
func (o *GetWorkflowRequests200Response) SetData(v []GetWorkflowRequests200ResponseDataInner) {
	o.Data = v
}

func (o GetWorkflowRequests200Response) MarshalJSON() ([]byte, error) {
...
func (o GetWorkflowRequests200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetWorkflowRequests200Response struct {
	value *GetWorkflowRequests200Response
	isSet bool
}

func (v NullableGetWorkflowRequests200Response) Get() *GetWorkflowRequests200Response {
	return v.value
}

func (v *NullableGetWorkflowRequests200Response) Set(val *GetWorkflowRequests200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWorkflowRequests200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWorkflowRequests200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWorkflowRequests200Response(val *GetWorkflowRequests200Response) *NullableGetWorkflowRequests200Response {
	return &NullableGetWorkflowRequests200Response{value: val, isSet: true}
}

func (v NullableGetWorkflowRequests200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWorkflowRequests200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
