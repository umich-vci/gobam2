...
// checks if the GetNamingPolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNamingPolicies200Response{}

// GetNamingPolicies200Response struct for GetNamingPolicies200Response
type GetNamingPolicies200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetNamingPolicies200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetNamingPolicies200Response() *GetNamingPolicies200Response {
	this := GetNamingPolicies200Response{}
	return &this
}
...
func (o *GetNamingPolicies200Response) GetData() []GetNamingPolicies200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetNamingPolicies200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetNamingPolicies200ResponseDataInner and assigns it to the Data field.
func (o *GetNamingPolicies200Response) SetData(v []GetNamingPolicies200ResponseDataInner) {
	o.Data = v
}

func (o GetNamingPolicies200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNamingPolicies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNamingPolicies200Response struct {
	value *GetNamingPolicies200Response
	isSet bool
}

func (v NullableGetNamingPolicies200Response) Get() *GetNamingPolicies200Response {
	return v.value
}

func (v *NullableGetNamingPolicies200Response) Set(val *GetNamingPolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNamingPolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNamingPolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNamingPolicies200Response(val *GetNamingPolicies200Response) *NullableGetNamingPolicies200Response {
	return &NullableGetNamingPolicies200Response{value: val, isSet: true}
}

func (v NullableGetNamingPolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNamingPolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
