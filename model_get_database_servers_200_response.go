...
// checks if the GetDatabaseServers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDatabaseServers200Response{}

// GetDatabaseServers200Response struct for GetDatabaseServers200Response
type GetDatabaseServers200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDatabaseServers200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDatabaseServers200Response() *GetDatabaseServers200Response {
	this := GetDatabaseServers200Response{}
	return &this
}
...
func (o *GetDatabaseServers200Response) GetData() []GetDatabaseServers200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDatabaseServers200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDatabaseServers200ResponseDataInner and assigns it to the Data field.
func (o *GetDatabaseServers200Response) SetData(v []GetDatabaseServers200ResponseDataInner) {
	o.Data = v
}

func (o GetDatabaseServers200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDatabaseServers200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDatabaseServers200Response struct {
	value *GetDatabaseServers200Response
	isSet bool
}

func (v NullableGetDatabaseServers200Response) Get() *GetDatabaseServers200Response {
	return v.value
}

func (v *NullableGetDatabaseServers200Response) Set(val *GetDatabaseServers200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDatabaseServers200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDatabaseServers200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDatabaseServers200Response(val *GetDatabaseServers200Response) *NullableGetDatabaseServers200Response {
	return &NullableGetDatabaseServers200Response{value: val, isSet: true}
}

func (v NullableGetDatabaseServers200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDatabaseServers200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
