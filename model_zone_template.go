...
// checks if the ZoneTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoneTemplate{}

// ZoneTemplate Lists the name of the zone template assigned to the zone.
...
func (o ZoneTemplate) MarshalJSON() ([]byte, error) {
...
func (o ZoneTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableZoneTemplate struct {
	value *ZoneTemplate
	isSet bool
}

func (v NullableZoneTemplate) Get() *ZoneTemplate {
	return v.value
}

func (v *NullableZoneTemplate) Set(val *ZoneTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableZoneTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableZoneTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoneTemplate(val *ZoneTemplate) *NullableZoneTemplate {
	return &NullableZoneTemplate{value: val, isSet: true}
}

func (v NullableZoneTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoneTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
