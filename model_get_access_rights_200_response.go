...
// checks if the GetAccessRights200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccessRights200Response{}

// GetAccessRights200Response struct for GetAccessRights200Response
type GetAccessRights200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetAccessRights200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetAccessRights200Response() *GetAccessRights200Response {
	this := GetAccessRights200Response{}
	return &this
}
...
func (o *GetAccessRights200Response) GetData() []GetAccessRights200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetAccessRights200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetAccessRights200ResponseDataInner and assigns it to the Data field.
func (o *GetAccessRights200Response) SetData(v []GetAccessRights200ResponseDataInner) {
	o.Data = v
}

func (o GetAccessRights200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAccessRights200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccessRights200Response struct {
	value *GetAccessRights200Response
	isSet bool
}

func (v NullableGetAccessRights200Response) Get() *GetAccessRights200Response {
	return v.value
}

func (v *NullableGetAccessRights200Response) Set(val *GetAccessRights200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccessRights200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccessRights200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccessRights200Response(val *GetAccessRights200Response) *NullableGetAccessRights200Response {
	return &NullableGetAccessRights200Response{value: val, isSet: true}
}

func (v NullableGetAccessRights200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccessRights200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
