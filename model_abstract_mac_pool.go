...
// checks if the AbstractMacPool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbstractMacPool{}

// AbstractMacPool struct for AbstractMacPool
type AbstractMacPool struct {
...
func (o AbstractMacPool) MarshalJSON() ([]byte, error) {
...
func (o AbstractMacPool) ToMap() (map[string]interface{}, error) {
...
type NullableAbstractMacPool struct {
	value *AbstractMacPool
	isSet bool
}

func (v NullableAbstractMacPool) Get() *AbstractMacPool {
	return v.value
}

func (v *NullableAbstractMacPool) Set(val *AbstractMacPool) {
	v.value = val
	v.isSet = true
}

func (v NullableAbstractMacPool) IsSet() bool {
	return v.isSet
}

func (v *NullableAbstractMacPool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbstractMacPool(val *AbstractMacPool) *NullableAbstractMacPool {
	return &NullableAbstractMacPool{value: val, isSet: true}
}

func (v NullableAbstractMacPool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbstractMacPool) UnmarshalJSON(src []byte) error {
	v.isSet = true
