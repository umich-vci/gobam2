...
// checks if the GetUserDefinedFieldDefinitions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserDefinedFieldDefinitions200Response{}

// GetUserDefinedFieldDefinitions200Response struct for GetUserDefinedFieldDefinitions200Response
type GetUserDefinedFieldDefinitions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetUserDefinedFieldDefinitions200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetUserDefinedFieldDefinitions200Response() *GetUserDefinedFieldDefinitions200Response {
	this := GetUserDefinedFieldDefinitions200Response{}
	return &this
}
...
func (o *GetUserDefinedFieldDefinitions200Response) GetData() []GetUserDefinedFieldDefinitions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetUserDefinedFieldDefinitions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetUserDefinedFieldDefinitions200ResponseDataInner and assigns it to the Data field.
func (o *GetUserDefinedFieldDefinitions200Response) SetData(v []GetUserDefinedFieldDefinitions200ResponseDataInner) {
	o.Data = v
}

func (o GetUserDefinedFieldDefinitions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetUserDefinedFieldDefinitions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetUserDefinedFieldDefinitions200Response struct {
	value *GetUserDefinedFieldDefinitions200Response
	isSet bool
}

func (v NullableGetUserDefinedFieldDefinitions200Response) Get() *GetUserDefinedFieldDefinitions200Response {
	return v.value
}

func (v *NullableGetUserDefinedFieldDefinitions200Response) Set(val *GetUserDefinedFieldDefinitions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserDefinedFieldDefinitions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserDefinedFieldDefinitions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserDefinedFieldDefinitions200Response(val *GetUserDefinedFieldDefinitions200Response) *NullableGetUserDefinedFieldDefinitions200Response {
	return &NullableGetUserDefinedFieldDefinitions200Response{value: val, isSet: true}
}

func (v NullableGetUserDefinedFieldDefinitions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserDefinedFieldDefinitions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
