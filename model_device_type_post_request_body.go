...
// checks if the DeviceTypePostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceTypePostRequestBody{}

// DeviceTypePostRequestBody struct for DeviceTypePostRequestBody
type DeviceTypePostRequestBody struct {
...
type _DeviceTypePostRequestBody DeviceTypePostRequestBody
...
func NewDeviceTypePostRequestBody(name string) *DeviceTypePostRequestBody {
	this := DeviceTypePostRequestBody{}
	this.Name = name
	return &this
}
...
func (o DeviceTypePostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o DeviceTypePostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceTypePostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceTypePostRequestBody := _DeviceTypePostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeviceTypePostRequestBody)

	if err != nil {
		return err
	}

	*o = DeviceTypePostRequestBody(varDeviceTypePostRequestBody)

	return err
}

type NullableDeviceTypePostRequestBody struct {
	value *DeviceTypePostRequestBody
	isSet bool
}

func (v NullableDeviceTypePostRequestBody) Get() *DeviceTypePostRequestBody {
	return v.value
}

func (v *NullableDeviceTypePostRequestBody) Set(val *DeviceTypePostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceTypePostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceTypePostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceTypePostRequestBody(val *DeviceTypePostRequestBody) *NullableDeviceTypePostRequestBody {
	return &NullableDeviceTypePostRequestBody{value: val, isSet: true}
}

func (v NullableDeviceTypePostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceTypePostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
