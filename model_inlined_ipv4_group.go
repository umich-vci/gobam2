...
// checks if the InlinedIPv4Group type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedIPv4Group{}

// InlinedIPv4Group struct for InlinedIPv4Group
...
func (o InlinedIPv4Group) MarshalJSON() ([]byte, error) {
...
func (o InlinedIPv4Group) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedIPv4Group struct {
	value *InlinedIPv4Group
	isSet bool
}

func (v NullableInlinedIPv4Group) Get() *InlinedIPv4Group {
	return v.value
}

func (v *NullableInlinedIPv4Group) Set(val *InlinedIPv4Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedIPv4Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedIPv4Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedIPv4Group(val *InlinedIPv4Group) *NullableInlinedIPv4Group {
	return &NullableInlinedIPv4Group{value: val, isSet: true}
}

func (v NullableInlinedIPv4Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedIPv4Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
