...
// checks if the GetConfigurations200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetConfigurations200ResponseDataInner{}

// GetConfigurations200ResponseDataInner struct for GetConfigurations200ResponseDataInner
type GetConfigurations200ResponseDataInner struct {
...
func NewGetConfigurations200ResponseDataInner() *GetConfigurations200ResponseDataInner {
	this := GetConfigurations200ResponseDataInner{}
	return &this
}
...
func (o GetConfigurations200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetConfigurations200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetConfigurations200ResponseDataInner struct {
	value *GetConfigurations200ResponseDataInner
	isSet bool
}

func (v NullableGetConfigurations200ResponseDataInner) Get() *GetConfigurations200ResponseDataInner {
	return v.value
}

func (v *NullableGetConfigurations200ResponseDataInner) Set(val *GetConfigurations200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConfigurations200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConfigurations200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConfigurations200ResponseDataInner(val *GetConfigurations200ResponseDataInner) *NullableGetConfigurations200ResponseDataInner {
	return &NullableGetConfigurations200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetConfigurations200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConfigurations200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
