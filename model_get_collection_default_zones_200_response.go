...
// checks if the GetCollectionDefaultZones200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionDefaultZones200Response{}

// GetCollectionDefaultZones200Response struct for GetCollectionDefaultZones200Response
type GetCollectionDefaultZones200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionDefaultZones200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionDefaultZones200Response() *GetCollectionDefaultZones200Response {
	this := GetCollectionDefaultZones200Response{}
	return &this
}
...
func (o *GetCollectionDefaultZones200Response) GetData() []GetCollectionDefaultZones200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionDefaultZones200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionDefaultZones200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionDefaultZones200Response) SetData(v []GetCollectionDefaultZones200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionDefaultZones200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionDefaultZones200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionDefaultZones200Response struct {
	value *GetCollectionDefaultZones200Response
	isSet bool
}

func (v NullableGetCollectionDefaultZones200Response) Get() *GetCollectionDefaultZones200Response {
	return v.value
}

func (v *NullableGetCollectionDefaultZones200Response) Set(val *GetCollectionDefaultZones200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionDefaultZones200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionDefaultZones200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionDefaultZones200Response(val *GetCollectionDefaultZones200Response) *NullableGetCollectionDefaultZones200Response {
	return &NullableGetCollectionDefaultZones200Response{value: val, isSet: true}
}

func (v NullableGetCollectionDefaultZones200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionDefaultZones200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
