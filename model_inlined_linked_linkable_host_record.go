...
// checks if the InlinedLinkedLinkableHostRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedLinkedLinkableHostRecord{}

// InlinedLinkedLinkableHostRecord struct for InlinedLinkedLinkableHostRecord
type InlinedLinkedLinkableHostRecord struct {
...
func NewInlinedLinkedLinkableHostRecord() *InlinedLinkedLinkableHostRecord {
	this := InlinedLinkedLinkableHostRecord{}
	return &this
}
...
func (o InlinedLinkedLinkableHostRecord) MarshalJSON() ([]byte, error) {
...
func (o InlinedLinkedLinkableHostRecord) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedLinkedLinkableHostRecord struct {
	value *InlinedLinkedLinkableHostRecord
	isSet bool
}

func (v NullableInlinedLinkedLinkableHostRecord) Get() *InlinedLinkedLinkableHostRecord {
	return v.value
}

func (v *NullableInlinedLinkedLinkableHostRecord) Set(val *InlinedLinkedLinkableHostRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedLinkedLinkableHostRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedLinkedLinkableHostRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedLinkedLinkableHostRecord(val *InlinedLinkedLinkableHostRecord) *NullableInlinedLinkedLinkableHostRecord {
	return &NullableInlinedLinkedLinkableHostRecord{value: val, isSet: true}
}

func (v NullableInlinedLinkedLinkableHostRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedLinkedLinkableHostRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
