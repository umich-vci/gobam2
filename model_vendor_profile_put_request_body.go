...
// checks if the VendorProfilePutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VendorProfilePutRequestBody{}

// VendorProfilePutRequestBody struct for VendorProfilePutRequestBody
type VendorProfilePutRequestBody struct {
...
type _VendorProfilePutRequestBody VendorProfilePutRequestBody
...
func NewVendorProfilePutRequestBody(name string, identifier string, description string) *VendorProfilePutRequestBody {
	this := VendorProfilePutRequestBody{}
	this.Name = name
...
func (o VendorProfilePutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o VendorProfilePutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *VendorProfilePutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varVendorProfilePutRequestBody := _VendorProfilePutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVendorProfilePutRequestBody)

	if err != nil {
		return err
	}

	*o = VendorProfilePutRequestBody(varVendorProfilePutRequestBody)

	return err
}

type NullableVendorProfilePutRequestBody struct {
	value *VendorProfilePutRequestBody
	isSet bool
}

func (v NullableVendorProfilePutRequestBody) Get() *VendorProfilePutRequestBody {
	return v.value
}

func (v *NullableVendorProfilePutRequestBody) Set(val *VendorProfilePutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableVendorProfilePutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableVendorProfilePutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVendorProfilePutRequestBody(val *VendorProfilePutRequestBody) *NullableVendorProfilePutRequestBody {
	return &NullableVendorProfilePutRequestBody{value: val, isSet: true}
}

func (v NullableVendorProfilePutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVendorProfilePutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
