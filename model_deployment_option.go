...
// checks if the DeploymentOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentOption{}

// DeploymentOption struct for DeploymentOption
...
func (o DeploymentOption) MarshalJSON() ([]byte, error) {
...
func (o DeploymentOption) ToMap() (map[string]interface{}, error) {
...
type NullableDeploymentOption struct {
	value *DeploymentOption
	isSet bool
}

func (v NullableDeploymentOption) Get() *DeploymentOption {
	return v.value
}

func (v *NullableDeploymentOption) Set(val *DeploymentOption) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentOption) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentOption(val *DeploymentOption) *NullableDeploymentOption {
	return &NullableDeploymentOption{value: val, isSet: true}
}

func (v NullableDeploymentOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
