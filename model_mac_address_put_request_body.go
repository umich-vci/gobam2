...
// checks if the MACAddressPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MACAddressPutRequestBody{}

// MACAddressPutRequestBody struct for MACAddressPutRequestBody
type MACAddressPutRequestBody struct {
...
type _MACAddressPutRequestBody MACAddressPutRequestBody
...
func (o MACAddressPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o MACAddressPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *MACAddressPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varMACAddressPutRequestBody := _MACAddressPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMACAddressPutRequestBody)

	if err != nil {
		return err
	}

	*o = MACAddressPutRequestBody(varMACAddressPutRequestBody)

	return err
}

type NullableMACAddressPutRequestBody struct {
	value *MACAddressPutRequestBody
	isSet bool
}

func (v NullableMACAddressPutRequestBody) Get() *MACAddressPutRequestBody {
	return v.value
}

func (v *NullableMACAddressPutRequestBody) Set(val *MACAddressPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableMACAddressPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableMACAddressPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMACAddressPutRequestBody(val *MACAddressPutRequestBody) *NullableMACAddressPutRequestBody {
	return &NullableMACAddressPutRequestBody{value: val, isSet: true}
}

func (v NullableMACAddressPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMACAddressPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
