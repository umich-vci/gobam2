...
// checks if the TrustRelationship type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustRelationship{}

// TrustRelationship struct for TrustRelationship
...
func (o TrustRelationship) MarshalJSON() ([]byte, error) {
...
func (o TrustRelationship) ToMap() (map[string]interface{}, error) {
...
type NullableTrustRelationship struct {
	value *TrustRelationship
	isSet bool
}

func (v NullableTrustRelationship) Get() *TrustRelationship {
	return v.value
}

func (v *NullableTrustRelationship) Set(val *TrustRelationship) {
	v.value = val
	v.isSet = true
}

func (v NullableTrustRelationship) IsSet() bool {
	return v.isSet
}

func (v *NullableTrustRelationship) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrustRelationship(val *TrustRelationship) *NullableTrustRelationship {
	return &NullableTrustRelationship{value: val, isSet: true}
}

func (v NullableTrustRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrustRelationship) UnmarshalJSON(src []byte) error {
	v.isSet = true
