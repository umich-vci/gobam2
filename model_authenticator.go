...
// checks if the Authenticator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Authenticator{}
...
func (o Authenticator) ToMap() (map[string]interface{}, error) {
