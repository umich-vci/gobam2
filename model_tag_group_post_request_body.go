...
// checks if the TagGroupPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagGroupPostRequestBody{}

// TagGroupPostRequestBody struct for TagGroupPostRequestBody
type TagGroupPostRequestBody struct {
...
type _TagGroupPostRequestBody TagGroupPostRequestBody
...
func (o TagGroupPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o TagGroupPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *TagGroupPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varTagGroupPostRequestBody := _TagGroupPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTagGroupPostRequestBody)

	if err != nil {
		return err
	}

	*o = TagGroupPostRequestBody(varTagGroupPostRequestBody)

	return err
}

type NullableTagGroupPostRequestBody struct {
	value *TagGroupPostRequestBody
	isSet bool
}

func (v NullableTagGroupPostRequestBody) Get() *TagGroupPostRequestBody {
	return v.value
}

func (v *NullableTagGroupPostRequestBody) Set(val *TagGroupPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableTagGroupPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableTagGroupPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagGroupPostRequestBody(val *TagGroupPostRequestBody) *NullableTagGroupPostRequestBody {
	return &NullableTagGroupPostRequestBody{value: val, isSet: true}
}

func (v NullableTagGroupPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagGroupPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
