...
// checks if the GetMacPools200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMacPools200Response{}

// GetMacPools200Response struct for GetMacPools200Response
type GetMacPools200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetMacPools200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetMacPools200Response) GetData() []GetMacPools200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetMacPools200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetMacPools200ResponseDataInner and assigns it to the Data field.
func (o *GetMacPools200Response) SetData(v []GetMacPools200ResponseDataInner) {
	o.Data = v
}

func (o GetMacPools200Response) MarshalJSON() ([]byte, error) {
...
func (o GetMacPools200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetMacPools200Response struct {
	value *GetMacPools200Response
	isSet bool
}

func (v NullableGetMacPools200Response) Get() *GetMacPools200Response {
	return v.value
}

func (v *NullableGetMacPools200Response) Set(val *GetMacPools200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMacPools200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMacPools200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMacPools200Response(val *GetMacPools200Response) *NullableGetMacPools200Response {
	return &NullableGetMacPools200Response{value: val, isSet: true}
}

func (v NullableGetMacPools200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMacPools200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
