...
// checks if the GetResourceRecords200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetResourceRecords200Response{}

// GetResourceRecords200Response struct for GetResourceRecords200Response
type GetResourceRecords200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetResourceRecords200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetResourceRecords200Response() *GetResourceRecords200Response {
	this := GetResourceRecords200Response{}
	return &this
}
...
func (o *GetResourceRecords200Response) GetData() []GetResourceRecords200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetResourceRecords200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetResourceRecords200ResponseDataInner and assigns it to the Data field.
func (o *GetResourceRecords200Response) SetData(v []GetResourceRecords200ResponseDataInner) {
	o.Data = v
}

func (o GetResourceRecords200Response) MarshalJSON() ([]byte, error) {
...
func (o GetResourceRecords200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetResourceRecords200Response struct {
	value *GetResourceRecords200Response
	isSet bool
}

func (v NullableGetResourceRecords200Response) Get() *GetResourceRecords200Response {
	return v.value
}

func (v *NullableGetResourceRecords200Response) Set(val *GetResourceRecords200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetResourceRecords200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetResourceRecords200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetResourceRecords200Response(val *GetResourceRecords200Response) *NullableGetResourceRecords200Response {
	return &NullableGetResourceRecords200Response{value: val, isSet: true}
}

func (v NullableGetResourceRecords200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetResourceRecords200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
