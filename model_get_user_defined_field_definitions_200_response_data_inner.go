...
// checks if the GetUserDefinedFieldDefinitions200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserDefinedFieldDefinitions200ResponseDataInner{}

// GetUserDefinedFieldDefinitions200ResponseDataInner struct for GetUserDefinedFieldDefinitions200ResponseDataInner
type GetUserDefinedFieldDefinitions200ResponseDataInner struct {
...
func NewGetUserDefinedFieldDefinitions200ResponseDataInner() *GetUserDefinedFieldDefinitions200ResponseDataInner {
	this := GetUserDefinedFieldDefinitions200ResponseDataInner{}
	return &this
}
...
func (o GetUserDefinedFieldDefinitions200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetUserDefinedFieldDefinitions200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetUserDefinedFieldDefinitions200ResponseDataInner struct {
	value *GetUserDefinedFieldDefinitions200ResponseDataInner
	isSet bool
}

func (v NullableGetUserDefinedFieldDefinitions200ResponseDataInner) Get() *GetUserDefinedFieldDefinitions200ResponseDataInner {
	return v.value
}

func (v *NullableGetUserDefinedFieldDefinitions200ResponseDataInner) Set(val *GetUserDefinedFieldDefinitions200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserDefinedFieldDefinitions200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserDefinedFieldDefinitions200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserDefinedFieldDefinitions200ResponseDataInner(val *GetUserDefinedFieldDefinitions200ResponseDataInner) *NullableGetUserDefinedFieldDefinitions200ResponseDataInner {
	return &NullableGetUserDefinedFieldDefinitions200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetUserDefinedFieldDefinitions200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserDefinedFieldDefinitions200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
