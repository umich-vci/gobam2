...
// checks if the DiscoveredRouter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscoveredRouter{}

// DiscoveredRouter struct for DiscoveredRouter
...
func (o DiscoveredRouter) MarshalJSON() ([]byte, error) {
...
func (o DiscoveredRouter) ToMap() (map[string]interface{}, error) {
...
type NullableDiscoveredRouter struct {
	value *DiscoveredRouter
	isSet bool
}

func (v NullableDiscoveredRouter) Get() *DiscoveredRouter {
	return v.value
}

func (v *NullableDiscoveredRouter) Set(val *DiscoveredRouter) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveredRouter) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveredRouter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveredRouter(val *DiscoveredRouter) *NullableDiscoveredRouter {
	return &NullableDiscoveredRouter{value: val, isSet: true}
}

func (v NullableDiscoveredRouter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveredRouter) UnmarshalJSON(src []byte) error {
	v.isSet = true
