...
type GetBlocks200Response struct {
	...
	Data []GetBlocks200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetBlocks200Response) GetData() []GetBlocks200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetBlocks200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetBlocks200ResponseDataInner and assigns it to the Data field.
