...
// checks if the ResponsePolicyPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsePolicyPostRequestBody{}

// ResponsePolicyPostRequestBody struct for ResponsePolicyPostRequestBody
type ResponsePolicyPostRequestBody struct {
...
type _ResponsePolicyPostRequestBody ResponsePolicyPostRequestBody
...
func NewResponsePolicyPostRequestBody(name string, policyType string) *ResponsePolicyPostRequestBody {
	this := ResponsePolicyPostRequestBody{}
	this.Name = name
...
func (o ResponsePolicyPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o ResponsePolicyPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *ResponsePolicyPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varResponsePolicyPostRequestBody := _ResponsePolicyPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponsePolicyPostRequestBody)

	if err != nil {
		return err
	}

	*o = ResponsePolicyPostRequestBody(varResponsePolicyPostRequestBody)

	return err
}

type NullableResponsePolicyPostRequestBody struct {
	value *ResponsePolicyPostRequestBody
	isSet bool
}

func (v NullableResponsePolicyPostRequestBody) Get() *ResponsePolicyPostRequestBody {
	return v.value
}

func (v *NullableResponsePolicyPostRequestBody) Set(val *ResponsePolicyPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsePolicyPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsePolicyPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsePolicyPostRequestBody(val *ResponsePolicyPostRequestBody) *NullableResponsePolicyPostRequestBody {
	return &NullableResponsePolicyPostRequestBody{value: val, isSet: true}
}

func (v NullableResponsePolicyPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsePolicyPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
