...
// checks if the GetDeploymentRoles200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeploymentRoles200Response{}

// GetDeploymentRoles200Response struct for GetDeploymentRoles200Response
type GetDeploymentRoles200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDeploymentRoles200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDeploymentRoles200Response() *GetDeploymentRoles200Response {
	this := GetDeploymentRoles200Response{}
	return &this
}
...
func (o *GetDeploymentRoles200Response) GetData() []GetDeploymentRoles200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDeploymentRoles200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDeploymentRoles200ResponseDataInner and assigns it to the Data field.
func (o *GetDeploymentRoles200Response) SetData(v []GetDeploymentRoles200ResponseDataInner) {
	o.Data = v
}

func (o GetDeploymentRoles200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDeploymentRoles200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeploymentRoles200Response struct {
	value *GetDeploymentRoles200Response
	isSet bool
}

func (v NullableGetDeploymentRoles200Response) Get() *GetDeploymentRoles200Response {
	return v.value
}

func (v *NullableGetDeploymentRoles200Response) Set(val *GetDeploymentRoles200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeploymentRoles200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeploymentRoles200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeploymentRoles200Response(val *GetDeploymentRoles200Response) *NullableGetDeploymentRoles200Response {
	return &NullableGetDeploymentRoles200Response{value: val, isSet: true}
}

func (v NullableGetDeploymentRoles200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeploymentRoles200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
