...
// checks if the DHCPUniqueIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPUniqueIdentifier{}

// DHCPUniqueIdentifier struct for DHCPUniqueIdentifier
type DHCPUniqueIdentifier struct {
	ClientIdentifier
	// The resource type.
...
func (o DHCPUniqueIdentifier) MarshalJSON() ([]byte, error) {
...
func (o DHCPUniqueIdentifier) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPUniqueIdentifier struct {
	value *DHCPUniqueIdentifier
	isSet bool
}

func (v NullableDHCPUniqueIdentifier) Get() *DHCPUniqueIdentifier {
	return v.value
}

func (v *NullableDHCPUniqueIdentifier) Set(val *DHCPUniqueIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPUniqueIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPUniqueIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPUniqueIdentifier(val *DHCPUniqueIdentifier) *NullableDHCPUniqueIdentifier {
	return &NullableDHCPUniqueIdentifier{value: val, isSet: true}
}

func (v NullableDHCPUniqueIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPUniqueIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
