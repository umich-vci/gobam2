...
// checks if the GetIpGroups200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIpGroups200Response{}

// GetIpGroups200Response struct for GetIpGroups200Response
type GetIpGroups200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetIpGroups200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetIpGroups200Response) GetData() []GetIpGroups200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetIpGroups200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetIpGroups200ResponseDataInner and assigns it to the Data field.
func (o *GetIpGroups200Response) SetData(v []GetIpGroups200ResponseDataInner) {
	o.Data = v
}

func (o GetIpGroups200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIpGroups200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetIpGroups200Response struct {
	value *GetIpGroups200Response
	isSet bool
}

func (v NullableGetIpGroups200Response) Get() *GetIpGroups200Response {
	return v.value
}

func (v *NullableGetIpGroups200Response) Set(val *GetIpGroups200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIpGroups200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIpGroups200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIpGroups200Response(val *GetIpGroups200Response) *NullableGetIpGroups200Response {
	return &NullableGetIpGroups200Response{value: val, isSet: true}
}

func (v NullableGetIpGroups200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIpGroups200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
