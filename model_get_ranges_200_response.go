...
// checks if the GetRanges200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRanges200Response{}

// GetRanges200Response struct for GetRanges200Response
type GetRanges200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetRanges200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetRanges200Response) GetData() []GetRanges200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetRanges200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetRanges200ResponseDataInner and assigns it to the Data field.
func (o *GetRanges200Response) SetData(v []GetRanges200ResponseDataInner) {
	o.Data = v
}

func (o GetRanges200Response) MarshalJSON() ([]byte, error) {
...
func (o GetRanges200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetRanges200Response struct {
	value *GetRanges200Response
	isSet bool
}

func (v NullableGetRanges200Response) Get() *GetRanges200Response {
	return v.value
}

func (v *NullableGetRanges200Response) Set(val *GetRanges200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRanges200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRanges200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRanges200Response(val *GetRanges200Response) *NullableGetRanges200Response {
	return &NullableGetRanges200Response{value: val, isSet: true}
}

func (v NullableGetRanges200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRanges200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
