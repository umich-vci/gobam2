...
// checks if the InlinedMACAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlinedMACAddress{}

// InlinedMACAddress struct for InlinedMACAddress
...
func (o InlinedMACAddress) MarshalJSON() ([]byte, error) {
...
func (o InlinedMACAddress) ToMap() (map[string]interface{}, error) {
...
type NullableInlinedMACAddress struct {
	value *InlinedMACAddress
	isSet bool
}

func (v NullableInlinedMACAddress) Get() *InlinedMACAddress {
	return v.value
}

func (v *NullableInlinedMACAddress) Set(val *InlinedMACAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableInlinedMACAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableInlinedMACAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlinedMACAddress(val *InlinedMACAddress) *NullableInlinedMACAddress {
	return &NullableInlinedMACAddress{value: val, isSet: true}
}

func (v NullableInlinedMACAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlinedMACAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
