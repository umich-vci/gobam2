...
// checks if the GetCollectionServers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionServers200Response{}

// GetCollectionServers200Response struct for GetCollectionServers200Response
type GetCollectionServers200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionServers200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionServers200Response() *GetCollectionServers200Response {
	this := GetCollectionServers200Response{}
	return &this
}
...
func (o *GetCollectionServers200Response) GetData() []GetCollectionServers200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionServers200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionServers200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionServers200Response) SetData(v []GetCollectionServers200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionServers200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionServers200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionServers200Response struct {
	value *GetCollectionServers200Response
	isSet bool
}

func (v NullableGetCollectionServers200Response) Get() *GetCollectionServers200Response {
	return v.value
}

func (v *NullableGetCollectionServers200Response) Set(val *GetCollectionServers200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionServers200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionServers200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionServers200Response(val *GetCollectionServers200Response) *NullableGetCollectionServers200Response {
	return &NullableGetCollectionServers200Response{value: val, isSet: true}
}

func (v NullableGetCollectionServers200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionServers200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
