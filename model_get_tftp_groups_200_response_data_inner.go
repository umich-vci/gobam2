...
// checks if the GetTftpGroups200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTftpGroups200ResponseDataInner{}

// GetTftpGroups200ResponseDataInner struct for GetTftpGroups200ResponseDataInner
type GetTftpGroups200ResponseDataInner struct {
...
func NewGetTftpGroups200ResponseDataInner() *GetTftpGroups200ResponseDataInner {
	this := GetTftpGroups200ResponseDataInner{}
	return &this
}
...
func (o GetTftpGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetTftpGroups200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetTftpGroups200ResponseDataInner struct {
	value *GetTftpGroups200ResponseDataInner
	isSet bool
}

func (v NullableGetTftpGroups200ResponseDataInner) Get() *GetTftpGroups200ResponseDataInner {
	return v.value
}

func (v *NullableGetTftpGroups200ResponseDataInner) Set(val *GetTftpGroups200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTftpGroups200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTftpGroups200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTftpGroups200ResponseDataInner(val *GetTftpGroups200ResponseDataInner) *NullableGetTftpGroups200ResponseDataInner {
	return &NullableGetTftpGroups200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetTftpGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTftpGroups200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
