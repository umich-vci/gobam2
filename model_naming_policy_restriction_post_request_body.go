...
// checks if the NamingPolicyRestrictionPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamingPolicyRestrictionPostRequestBody{}

// NamingPolicyRestrictionPostRequestBody struct for NamingPolicyRestrictionPostRequestBody
type NamingPolicyRestrictionPostRequestBody struct {
	...
	Restrictions []ValueMatchTypePairBean `json:"restrictions"`
}

type _NamingPolicyRestrictionPostRequestBody NamingPolicyRestrictionPostRequestBody
...
func NewNamingPolicyRestrictionPostRequestBody(name string, restrictions []ValueMatchTypePairBean) *NamingPolicyRestrictionPostRequestBody {
	this := NamingPolicyRestrictionPostRequestBody{}
	this.Name = name
...
func (o *NamingPolicyRestrictionPostRequestBody) GetRestrictions() []ValueMatchTypePairBean {
	if o == nil {
		var ret []ValueMatchTypePairBean
		return ret
	}
...
func (o NamingPolicyRestrictionPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o NamingPolicyRestrictionPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *NamingPolicyRestrictionPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varNamingPolicyRestrictionPostRequestBody := _NamingPolicyRestrictionPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNamingPolicyRestrictionPostRequestBody)

	if err != nil {
		return err
	}

	*o = NamingPolicyRestrictionPostRequestBody(varNamingPolicyRestrictionPostRequestBody)

	return err
}

type NullableNamingPolicyRestrictionPostRequestBody struct {
	value *NamingPolicyRestrictionPostRequestBody
	isSet bool
}

func (v NullableNamingPolicyRestrictionPostRequestBody) Get() *NamingPolicyRestrictionPostRequestBody {
	return v.value
}

func (v *NullableNamingPolicyRestrictionPostRequestBody) Set(val *NamingPolicyRestrictionPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableNamingPolicyRestrictionPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableNamingPolicyRestrictionPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamingPolicyRestrictionPostRequestBody(val *NamingPolicyRestrictionPostRequestBody) *NullableNamingPolicyRestrictionPostRequestBody {
	return &NullableNamingPolicyRestrictionPostRequestBody{value: val, isSet: true}
}

func (v NullableNamingPolicyRestrictionPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamingPolicyRestrictionPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
