...
// checks if the GetServerServices200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerServices200Response{}

// GetServerServices200Response struct for GetServerServices200Response
type GetServerServices200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetServerServices200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetServerServices200Response() *GetServerServices200Response {
	this := GetServerServices200Response{}
	return &this
}
...
func (o *GetServerServices200Response) GetData() []GetServerServices200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetServerServices200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetServerServices200ResponseDataInner and assigns it to the Data field.
func (o *GetServerServices200Response) SetData(v []GetServerServices200ResponseDataInner) {
	o.Data = v
}

func (o GetServerServices200Response) MarshalJSON() ([]byte, error) {
...
func (o GetServerServices200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerServices200Response struct {
	value *GetServerServices200Response
	isSet bool
}

func (v NullableGetServerServices200Response) Get() *GetServerServices200Response {
	return v.value
}

func (v *NullableGetServerServices200Response) Set(val *GetServerServices200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerServices200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerServices200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerServices200Response(val *GetServerServices200Response) *NullableGetServerServices200Response {
	return &NullableGetServerServices200Response{value: val, isSet: true}
}

func (v NullableGetServerServices200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerServices200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
