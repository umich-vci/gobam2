...
// checks if the GetCollectionUserDefinedLinks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionUserDefinedLinks200Response{}

// GetCollectionUserDefinedLinks200Response struct for GetCollectionUserDefinedLinks200Response
type GetCollectionUserDefinedLinks200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionUserDefinedLinks200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionUserDefinedLinks200Response() *GetCollectionUserDefinedLinks200Response {
	this := GetCollectionUserDefinedLinks200Response{}
	return &this
}
...
func (o *GetCollectionUserDefinedLinks200Response) GetData() []GetCollectionUserDefinedLinks200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionUserDefinedLinks200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionUserDefinedLinks200ResponseDataInner and assigns it to the Data field.
func (o *GetCollectionUserDefinedLinks200Response) SetData(v []GetCollectionUserDefinedLinks200ResponseDataInner) {
	o.Data = v
}

func (o GetCollectionUserDefinedLinks200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionUserDefinedLinks200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionUserDefinedLinks200Response struct {
	value *GetCollectionUserDefinedLinks200Response
	isSet bool
}

func (v NullableGetCollectionUserDefinedLinks200Response) Get() *GetCollectionUserDefinedLinks200Response {
	return v.value
}

func (v *NullableGetCollectionUserDefinedLinks200Response) Set(val *GetCollectionUserDefinedLinks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionUserDefinedLinks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionUserDefinedLinks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionUserDefinedLinks200Response(val *GetCollectionUserDefinedLinks200Response) *NullableGetCollectionUserDefinedLinks200Response {
	return &NullableGetCollectionUserDefinedLinks200Response{value: val, isSet: true}
}

func (v NullableGetCollectionUserDefinedLinks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionUserDefinedLinks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
