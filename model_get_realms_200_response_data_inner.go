...
// checks if the GetRealms200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRealms200ResponseDataInner{}

// GetRealms200ResponseDataInner struct for GetRealms200ResponseDataInner
type GetRealms200ResponseDataInner struct {
...
func NewGetRealms200ResponseDataInner() *GetRealms200ResponseDataInner {
	this := GetRealms200ResponseDataInner{}
	return &this
}
...
func (o GetRealms200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetRealms200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetRealms200ResponseDataInner struct {
	value *GetRealms200ResponseDataInner
	isSet bool
}

func (v NullableGetRealms200ResponseDataInner) Get() *GetRealms200ResponseDataInner {
	return v.value
}

func (v *NullableGetRealms200ResponseDataInner) Set(val *GetRealms200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRealms200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRealms200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRealms200ResponseDataInner(val *GetRealms200ResponseDataInner) *NullableGetRealms200ResponseDataInner {
	return &NullableGetRealms200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetRealms200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRealms200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
