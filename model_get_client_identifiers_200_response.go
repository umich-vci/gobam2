...
// checks if the GetClientIdentifiers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetClientIdentifiers200Response{}

// GetClientIdentifiers200Response struct for GetClientIdentifiers200Response
type GetClientIdentifiers200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetClientIdentifiers200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetClientIdentifiers200Response() *GetClientIdentifiers200Response {
	this := GetClientIdentifiers200Response{}
	return &this
}
...
func (o *GetClientIdentifiers200Response) GetData() []GetClientIdentifiers200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetClientIdentifiers200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetClientIdentifiers200ResponseDataInner and assigns it to the Data field.
func (o *GetClientIdentifiers200Response) SetData(v []GetClientIdentifiers200ResponseDataInner) {
	o.Data = v
}

func (o GetClientIdentifiers200Response) MarshalJSON() ([]byte, error) {
...
func (o GetClientIdentifiers200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetClientIdentifiers200Response struct {
	value *GetClientIdentifiers200Response
	isSet bool
}

func (v NullableGetClientIdentifiers200Response) Get() *GetClientIdentifiers200Response {
	return v.value
}

func (v *NullableGetClientIdentifiers200Response) Set(val *GetClientIdentifiers200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetClientIdentifiers200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetClientIdentifiers200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetClientIdentifiers200Response(val *GetClientIdentifiers200Response) *NullableGetClientIdentifiers200Response {
	return &NullableGetClientIdentifiers200Response{value: val, isSet: true}
}

func (v NullableGetClientIdentifiers200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetClientIdentifiers200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
