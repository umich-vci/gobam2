...
// DNSSECResourcesAPIService DNSSECResourcesAPI service
type DNSSECResourcesAPIService service

type ApiDeleteSigningKeyRequest struct {
	ctx context.Context
	ApiService *DNSSECResourcesAPIService
	id int64
...
*/
func (a *DNSSECResourcesAPIService) DeleteSigningKey(ctx context.Context, id int64) ApiDeleteSigningKeyRequest {
	return ApiDeleteSigningKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *DNSSECResourcesAPIService) DeleteSigningKeyExecute(r ApiDeleteSigningKeyRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.DeleteSigningKey")
	if err != nil {
...
*/
func (a *DNSSECResourcesAPIService) GetCollectionSigningKeys(ctx context.Context, collection string, collectionId int64) ApiGetCollectionSigningKeysRequest {
	return ApiGetCollectionSigningKeysRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *DNSSECResourcesAPIService) GetCollectionSigningKeysExecute(r ApiGetCollectionSigningKeysRequest) (*GetSigningKeys200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.GetCollectionSigningKeys")
	if err != nil {
...
*/
func (a *DNSSECResourcesAPIService) GetSigningKey(ctx context.Context, id int64) ApiGetSigningKeyRequest {
	return ApiGetSigningKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *DNSSECResourcesAPIService) GetSigningKeyExecute(r ApiGetSigningKeyRequest) (*GetSigningKeys200ResponseDataInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.GetSigningKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DNSSECResourcesAPIService) GetSigningKeys(ctx context.Context) ApiGetSigningKeysRequest {
	return ApiGetSigningKeysRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetSigningKeys200Response
func (a *DNSSECResourcesAPIService) GetSigningKeysExecute(r ApiGetSigningKeysRequest) (*GetSigningKeys200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.GetSigningKeys")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DNSSECResourcesAPIService) PatchSigningKey(ctx context.Context, id int64) ApiPatchSigningKeyRequest {
	return ApiPatchSigningKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetSigningKeys200ResponseDataInner
func (a *DNSSECResourcesAPIService) PatchSigningKeyExecute(r ApiPatchSigningKeyRequest) (*GetSigningKeys200ResponseDataInner, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.PatchSigningKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DNSSECResourcesAPIService) PostCollectionSigningKey(ctx context.Context, collection string, collectionId int64) ApiPostCollectionSigningKeyRequest {
	return ApiPostCollectionSigningKeyRequest{
		ApiService: a,
		ctx: ctx,
		collection: collection,
...
func (a *DNSSECResourcesAPIService) PostCollectionSigningKeyExecute(r ApiPostCollectionSigningKeyRequest) (*PutSigningKey200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.PostCollectionSigningKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DNSSECResourcesAPIService) PutSigningKey(ctx context.Context, id int64) ApiPutSigningKeyRequest {
	return ApiPutSigningKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return PutSigningKey200Response
func (a *DNSSECResourcesAPIService) PutSigningKeyExecute(r ApiPutSigningKeyRequest) (*PutSigningKey200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DNSSECResourcesAPIService.PutSigningKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
