...
// checks if the KerberosRealmPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosRealmPostRequestBody{}

// KerberosRealmPostRequestBody struct for KerberosRealmPostRequestBody
type KerberosRealmPostRequestBody struct {
...
type _KerberosRealmPostRequestBody KerberosRealmPostRequestBody
...
func NewKerberosRealmPostRequestBody(name string, domain string) *KerberosRealmPostRequestBody {
	this := KerberosRealmPostRequestBody{}
	this.Name = name
	this.Domain = domain
	return &this
}
...
func (o KerberosRealmPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o KerberosRealmPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *KerberosRealmPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varKerberosRealmPostRequestBody := _KerberosRealmPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKerberosRealmPostRequestBody)

	if err != nil {
		return err
	}

	*o = KerberosRealmPostRequestBody(varKerberosRealmPostRequestBody)

	return err
}

type NullableKerberosRealmPostRequestBody struct {
	value *KerberosRealmPostRequestBody
	isSet bool
}

func (v NullableKerberosRealmPostRequestBody) Get() *KerberosRealmPostRequestBody {
	return v.value
}

func (v *NullableKerberosRealmPostRequestBody) Set(val *KerberosRealmPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableKerberosRealmPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableKerberosRealmPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKerberosRealmPostRequestBody(val *KerberosRealmPostRequestBody) *NullableKerberosRealmPostRequestBody {
	return &NullableKerberosRealmPostRequestBody{value: val, isSet: true}
}

func (v NullableKerberosRealmPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKerberosRealmPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
