...
// checks if the GetDeviceTypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceTypes200Response{}

// GetDeviceTypes200Response struct for GetDeviceTypes200Response
type GetDeviceTypes200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDeviceTypes200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDeviceTypes200Response() *GetDeviceTypes200Response {
	this := GetDeviceTypes200Response{}
	return &this
}
...
func (o *GetDeviceTypes200Response) GetData() []GetDeviceTypes200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDeviceTypes200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDeviceTypes200ResponseDataInner and assigns it to the Data field.
func (o *GetDeviceTypes200Response) SetData(v []GetDeviceTypes200ResponseDataInner) {
	o.Data = v
}

func (o GetDeviceTypes200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceTypes200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeviceTypes200Response struct {
	value *GetDeviceTypes200Response
	isSet bool
}

func (v NullableGetDeviceTypes200Response) Get() *GetDeviceTypes200Response {
	return v.value
}

func (v *NullableGetDeviceTypes200Response) Set(val *GetDeviceTypes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceTypes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceTypes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceTypes200Response(val *GetDeviceTypes200Response) *NullableGetDeviceTypes200Response {
	return &NullableGetDeviceTypes200Response{value: val, isSet: true}
}

func (v NullableGetDeviceTypes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceTypes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
