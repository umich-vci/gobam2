...
type MXRecord struct {
	...
	LinkedRecord *MXRecordAllOfLinkedRecord `json:"linkedRecord,omitempty"`
	// The priority assigned to the mail exchanger. A lower value indicates a higher priotiry.
...
func (o *MXRecord) GetLinkedRecord() MXRecordAllOfLinkedRecord {
	if o == nil || IsNil(o.LinkedRecord) {
		var ret MXRecordAllOfLinkedRecord
		return ret
	}
...
// SetLinkedRecord gets a reference to the given MXRecordAllOfLinkedRecord and assigns it to the LinkedRecord field.
