...
// checks if the GetDeviceSubtypes200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceSubtypes200ResponseDataInner{}

// GetDeviceSubtypes200ResponseDataInner struct for GetDeviceSubtypes200ResponseDataInner
type GetDeviceSubtypes200ResponseDataInner struct {
...
func NewGetDeviceSubtypes200ResponseDataInner() *GetDeviceSubtypes200ResponseDataInner {
	this := GetDeviceSubtypes200ResponseDataInner{}
	return &this
}
...
func (o GetDeviceSubtypes200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceSubtypes200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeviceSubtypes200ResponseDataInner struct {
	value *GetDeviceSubtypes200ResponseDataInner
	isSet bool
}

func (v NullableGetDeviceSubtypes200ResponseDataInner) Get() *GetDeviceSubtypes200ResponseDataInner {
	return v.value
}

func (v *NullableGetDeviceSubtypes200ResponseDataInner) Set(val *GetDeviceSubtypes200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceSubtypes200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceSubtypes200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceSubtypes200ResponseDataInner(val *GetDeviceSubtypes200ResponseDataInner) *NullableGetDeviceSubtypes200ResponseDataInner {
	return &NullableGetDeviceSubtypes200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetDeviceSubtypes200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceSubtypes200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
