...
// checks if the TFTPGroupPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TFTPGroupPutRequestBody{}

// TFTPGroupPutRequestBody struct for TFTPGroupPutRequestBody
type TFTPGroupPutRequestBody struct {
...
func (o TFTPGroupPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o TFTPGroupPutRequestBody) ToMap() (map[string]interface{}, error) {
...
type NullableTFTPGroupPutRequestBody struct {
	value *TFTPGroupPutRequestBody
	isSet bool
}

func (v NullableTFTPGroupPutRequestBody) Get() *TFTPGroupPutRequestBody {
	return v.value
}

func (v *NullableTFTPGroupPutRequestBody) Set(val *TFTPGroupPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableTFTPGroupPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableTFTPGroupPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTFTPGroupPutRequestBody(val *TFTPGroupPutRequestBody) *NullableTFTPGroupPutRequestBody {
	return &NullableTFTPGroupPutRequestBody{value: val, isSet: true}
}

func (v NullableTFTPGroupPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTFTPGroupPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
