...
// checks if the GetPolicyItems200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPolicyItems200ResponseDataInner{}

// GetPolicyItems200ResponseDataInner struct for GetPolicyItems200ResponseDataInner
type GetPolicyItems200ResponseDataInner struct {
...
func NewGetPolicyItems200ResponseDataInner() *GetPolicyItems200ResponseDataInner {
	this := GetPolicyItems200ResponseDataInner{}
	return &this
}
...
func (o GetPolicyItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetPolicyItems200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetPolicyItems200ResponseDataInner struct {
	value *GetPolicyItems200ResponseDataInner
	isSet bool
}

func (v NullableGetPolicyItems200ResponseDataInner) Get() *GetPolicyItems200ResponseDataInner {
	return v.value
}

func (v *NullableGetPolicyItems200ResponseDataInner) Set(val *GetPolicyItems200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPolicyItems200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPolicyItems200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPolicyItems200ResponseDataInner(val *GetPolicyItems200ResponseDataInner) *NullableGetPolicyItems200ResponseDataInner {
	return &NullableGetPolicyItems200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetPolicyItems200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPolicyItems200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
