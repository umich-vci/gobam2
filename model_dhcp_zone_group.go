...
// checks if the DHCPZoneGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPZoneGroup{}

// DHCPZoneGroup struct for DHCPZoneGroup
type DHCPZoneGroup struct {
...
func (o DHCPZoneGroup) MarshalJSON() ([]byte, error) {
...
func (o DHCPZoneGroup) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPZoneGroup struct {
	value *DHCPZoneGroup
	isSet bool
}

func (v NullableDHCPZoneGroup) Get() *DHCPZoneGroup {
	return v.value
}

func (v *NullableDHCPZoneGroup) Set(val *DHCPZoneGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPZoneGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPZoneGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPZoneGroup(val *DHCPZoneGroup) *NullableDHCPZoneGroup {
	return &NullableDHCPZoneGroup{value: val, isSet: true}
}

func (v NullableDHCPZoneGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPZoneGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
