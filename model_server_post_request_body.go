...
// checks if the ServerPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerPostRequestBody{}

// ServerPostRequestBody struct for ServerPostRequestBody
type ServerPostRequestBody struct {
...
type _ServerPostRequestBody ServerPostRequestBody
...
func (o ServerPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o ServerPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *ServerPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varServerPostRequestBody := _ServerPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServerPostRequestBody)

	if err != nil {
		return err
	}

	*o = ServerPostRequestBody(varServerPostRequestBody)

	return err
}

type NullableServerPostRequestBody struct {
	value *ServerPostRequestBody
	isSet bool
}

func (v NullableServerPostRequestBody) Get() *ServerPostRequestBody {
	return v.value
}

func (v *NullableServerPostRequestBody) Set(val *ServerPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableServerPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableServerPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerPostRequestBody(val *ServerPostRequestBody) *NullableServerPostRequestBody {
	return &NullableServerPostRequestBody{value: val, isSet: true}
}

func (v NullableServerPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
