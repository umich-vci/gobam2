...
// checks if the GetTemplateItems200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTemplateItems200Response{}

// GetTemplateItems200Response struct for GetTemplateItems200Response
type GetTemplateItems200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetTemplateItems200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetTemplateItems200Response() *GetTemplateItems200Response {
	this := GetTemplateItems200Response{}
	return &this
}
...
func (o *GetTemplateItems200Response) GetData() []GetTemplateItems200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetTemplateItems200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetTemplateItems200ResponseDataInner and assigns it to the Data field.
func (o *GetTemplateItems200Response) SetData(v []GetTemplateItems200ResponseDataInner) {
	o.Data = v
}

func (o GetTemplateItems200Response) MarshalJSON() ([]byte, error) {
...
func (o GetTemplateItems200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetTemplateItems200Response struct {
	value *GetTemplateItems200Response
	isSet bool
}

func (v NullableGetTemplateItems200Response) Get() *GetTemplateItems200Response {
	return v.value
}

func (v *NullableGetTemplateItems200Response) Set(val *GetTemplateItems200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTemplateItems200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTemplateItems200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTemplateItems200Response(val *GetTemplateItems200Response) *NullableGetTemplateItems200Response {
	return &NullableGetTemplateItems200Response{value: val, isSet: true}
}

func (v NullableGetTemplateItems200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTemplateItems200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
