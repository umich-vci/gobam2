...
// checks if the NamingPolicyPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamingPolicyPutRequestBody{}

// NamingPolicyPutRequestBody struct for NamingPolicyPutRequestBody
type NamingPolicyPutRequestBody struct {
...
type _NamingPolicyPutRequestBody NamingPolicyPutRequestBody
...
func NewNamingPolicyPutRequestBody(name string) *NamingPolicyPutRequestBody {
	this := NamingPolicyPutRequestBody{}
	this.Name = name
	return &this
}
...
func (o NamingPolicyPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o NamingPolicyPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *NamingPolicyPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varNamingPolicyPutRequestBody := _NamingPolicyPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNamingPolicyPutRequestBody)

	if err != nil {
		return err
	}

	*o = NamingPolicyPutRequestBody(varNamingPolicyPutRequestBody)

	return err
}

type NullableNamingPolicyPutRequestBody struct {
	value *NamingPolicyPutRequestBody
	isSet bool
}

func (v NullableNamingPolicyPutRequestBody) Get() *NamingPolicyPutRequestBody {
	return v.value
}

func (v *NullableNamingPolicyPutRequestBody) Set(val *NamingPolicyPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableNamingPolicyPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableNamingPolicyPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamingPolicyPutRequestBody(val *NamingPolicyPutRequestBody) *NullableNamingPolicyPutRequestBody {
	return &NullableNamingPolicyPutRequestBody{value: val, isSet: true}
}

func (v NullableNamingPolicyPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamingPolicyPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
