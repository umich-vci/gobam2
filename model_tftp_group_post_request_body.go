...
// checks if the TFTPGroupPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TFTPGroupPostRequestBody{}

// TFTPGroupPostRequestBody struct for TFTPGroupPostRequestBody
type TFTPGroupPostRequestBody struct {
...
type _TFTPGroupPostRequestBody TFTPGroupPostRequestBody
...
func (o TFTPGroupPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o TFTPGroupPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *TFTPGroupPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varTFTPGroupPostRequestBody := _TFTPGroupPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTFTPGroupPostRequestBody)

	if err != nil {
		return err
	}

	*o = TFTPGroupPostRequestBody(varTFTPGroupPostRequestBody)

	return err
}

type NullableTFTPGroupPostRequestBody struct {
	value *TFTPGroupPostRequestBody
	isSet bool
}

func (v NullableTFTPGroupPostRequestBody) Get() *TFTPGroupPostRequestBody {
	return v.value
}

func (v *NullableTFTPGroupPostRequestBody) Set(val *TFTPGroupPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableTFTPGroupPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableTFTPGroupPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTFTPGroupPostRequestBody(val *TFTPGroupPostRequestBody) *NullableTFTPGroupPostRequestBody {
	return &NullableTFTPGroupPostRequestBody{value: val, isSet: true}
}

func (v NullableTFTPGroupPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTFTPGroupPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
