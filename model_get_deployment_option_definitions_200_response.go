...
// checks if the GetDeploymentOptionDefinitions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeploymentOptionDefinitions200Response{}

// GetDeploymentOptionDefinitions200Response struct for GetDeploymentOptionDefinitions200Response
type GetDeploymentOptionDefinitions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetDeploymentOptionDefinitions200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetDeploymentOptionDefinitions200Response() *GetDeploymentOptionDefinitions200Response {
	this := GetDeploymentOptionDefinitions200Response{}
	return &this
}
...
func (o *GetDeploymentOptionDefinitions200Response) GetData() []GetDeploymentOptionDefinitions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetDeploymentOptionDefinitions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetDeploymentOptionDefinitions200ResponseDataInner and assigns it to the Data field.
func (o *GetDeploymentOptionDefinitions200Response) SetData(v []GetDeploymentOptionDefinitions200ResponseDataInner) {
	o.Data = v
}

func (o GetDeploymentOptionDefinitions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDeploymentOptionDefinitions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeploymentOptionDefinitions200Response struct {
	value *GetDeploymentOptionDefinitions200Response
	isSet bool
}

func (v NullableGetDeploymentOptionDefinitions200Response) Get() *GetDeploymentOptionDefinitions200Response {
	return v.value
}

func (v *NullableGetDeploymentOptionDefinitions200Response) Set(val *GetDeploymentOptionDefinitions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeploymentOptionDefinitions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeploymentOptionDefinitions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeploymentOptionDefinitions200Response(val *GetDeploymentOptionDefinitions200Response) *NullableGetDeploymentOptionDefinitions200Response {
	return &NullableGetDeploymentOptionDefinitions200Response{value: val, isSet: true}
}

func (v NullableGetDeploymentOptionDefinitions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeploymentOptionDefinitions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
