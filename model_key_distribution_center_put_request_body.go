...
// checks if the KeyDistributionCenterPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyDistributionCenterPutRequestBody{}

// KeyDistributionCenterPutRequestBody struct for KeyDistributionCenterPutRequestBody
type KeyDistributionCenterPutRequestBody struct {
...
type _KeyDistributionCenterPutRequestBody KeyDistributionCenterPutRequestBody
...
func NewKeyDistributionCenterPutRequestBody(name string, host string, port int32) *KeyDistributionCenterPutRequestBody {
	this := KeyDistributionCenterPutRequestBody{}
	this.Name = name
	this.Host = host
	this.Port = port
	return &this
...
func (o KeyDistributionCenterPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o KeyDistributionCenterPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *KeyDistributionCenterPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varKeyDistributionCenterPutRequestBody := _KeyDistributionCenterPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKeyDistributionCenterPutRequestBody)

	if err != nil {
		return err
	}

	*o = KeyDistributionCenterPutRequestBody(varKeyDistributionCenterPutRequestBody)

	return err
}

type NullableKeyDistributionCenterPutRequestBody struct {
	value *KeyDistributionCenterPutRequestBody
	isSet bool
}

func (v NullableKeyDistributionCenterPutRequestBody) Get() *KeyDistributionCenterPutRequestBody {
	return v.value
}

func (v *NullableKeyDistributionCenterPutRequestBody) Set(val *KeyDistributionCenterPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableKeyDistributionCenterPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableKeyDistributionCenterPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKeyDistributionCenterPutRequestBody(val *KeyDistributionCenterPutRequestBody) *NullableKeyDistributionCenterPutRequestBody {
	return &NullableKeyDistributionCenterPutRequestBody{value: val, isSet: true}
}

func (v NullableKeyDistributionCenterPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKeyDistributionCenterPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
