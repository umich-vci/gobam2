...
// checks if the DHCPv4ClientOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPv4ClientOption{}

// DHCPv4ClientOption struct for DHCPv4ClientOption
type DHCPv4ClientOption struct {
	DeploymentOption
	// The resource type.
	...
	Definition *InlinedDhcpv4ClientOptionDefinition `json:"definition,omitempty"`
}
...
func (o *DHCPv4ClientOption) GetDefinition() InlinedDhcpv4ClientOptionDefinition {
	if o == nil || IsNil(o.Definition) {
		var ret InlinedDhcpv4ClientOptionDefinition
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given InlinedDhcpv4ClientOptionDefinition and assigns it to the Definition field.
func (o *DHCPv4ClientOption) SetDefinition(v InlinedDhcpv4ClientOptionDefinition) {
	o.Definition = &v
}

func (o DHCPv4ClientOption) MarshalJSON() ([]byte, error) {
...
func (o DHCPv4ClientOption) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPv4ClientOption struct {
	value *DHCPv4ClientOption
	isSet bool
}

func (v NullableDHCPv4ClientOption) Get() *DHCPv4ClientOption {
	return v.value
}

func (v *NullableDHCPv4ClientOption) Set(val *DHCPv4ClientOption) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPv4ClientOption) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPv4ClientOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPv4ClientOption(val *DHCPv4ClientOption) *NullableDHCPv4ClientOption {
	return &NullableDHCPv4ClientOption{value: val, isSet: true}
}

func (v NullableDHCPv4ClientOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPv4ClientOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
