...
// checks if the GetZoneGroups200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetZoneGroups200ResponseDataInner{}

// GetZoneGroups200ResponseDataInner struct for GetZoneGroups200ResponseDataInner
type GetZoneGroups200ResponseDataInner struct {
...
func NewGetZoneGroups200ResponseDataInner() *GetZoneGroups200ResponseDataInner {
	this := GetZoneGroups200ResponseDataInner{}
	return &this
}
...
func (o GetZoneGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetZoneGroups200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetZoneGroups200ResponseDataInner struct {
	value *GetZoneGroups200ResponseDataInner
	isSet bool
}

func (v NullableGetZoneGroups200ResponseDataInner) Get() *GetZoneGroups200ResponseDataInner {
	return v.value
}

func (v *NullableGetZoneGroups200ResponseDataInner) Set(val *GetZoneGroups200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetZoneGroups200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetZoneGroups200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetZoneGroups200ResponseDataInner(val *GetZoneGroups200ResponseDataInner) *NullableGetZoneGroups200ResponseDataInner {
	return &NullableGetZoneGroups200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetZoneGroups200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetZoneGroups200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
