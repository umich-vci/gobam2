...
// checks if the GetVendorProfiles200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetVendorProfiles200ResponseDataInner{}

// GetVendorProfiles200ResponseDataInner struct for GetVendorProfiles200ResponseDataInner
type GetVendorProfiles200ResponseDataInner struct {
...
func NewGetVendorProfiles200ResponseDataInner() *GetVendorProfiles200ResponseDataInner {
	this := GetVendorProfiles200ResponseDataInner{}
	return &this
}
...
func (o GetVendorProfiles200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetVendorProfiles200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetVendorProfiles200ResponseDataInner struct {
	value *GetVendorProfiles200ResponseDataInner
	isSet bool
}

func (v NullableGetVendorProfiles200ResponseDataInner) Get() *GetVendorProfiles200ResponseDataInner {
	return v.value
}

func (v *NullableGetVendorProfiles200ResponseDataInner) Set(val *GetVendorProfiles200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetVendorProfiles200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetVendorProfiles200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetVendorProfiles200ResponseDataInner(val *GetVendorProfiles200ResponseDataInner) *NullableGetVendorProfiles200ResponseDataInner {
	return &NullableGetVendorProfiles200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetVendorProfiles200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetVendorProfiles200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
