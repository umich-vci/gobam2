...
// checks if the GetSigningPolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSigningPolicies200Response{}

// GetSigningPolicies200Response struct for GetSigningPolicies200Response
type GetSigningPolicies200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetSigningPolicies200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetSigningPolicies200Response() *GetSigningPolicies200Response {
	this := GetSigningPolicies200Response{}
	return &this
}
...
func (o *GetSigningPolicies200Response) GetData() []GetSigningPolicies200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetSigningPolicies200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetSigningPolicies200ResponseDataInner and assigns it to the Data field.
func (o *GetSigningPolicies200Response) SetData(v []GetSigningPolicies200ResponseDataInner) {
	o.Data = v
}

func (o GetSigningPolicies200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSigningPolicies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSigningPolicies200Response struct {
	value *GetSigningPolicies200Response
	isSet bool
}

func (v NullableGetSigningPolicies200Response) Get() *GetSigningPolicies200Response {
	return v.value
}

func (v *NullableGetSigningPolicies200Response) Set(val *GetSigningPolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSigningPolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSigningPolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSigningPolicies200Response(val *GetSigningPolicies200Response) *NullableGetSigningPolicies200Response {
	return &NullableGetSigningPolicies200Response{value: val, isSet: true}
}

func (v NullableGetSigningPolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSigningPolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
