...
// checks if the GetResources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetResources200Response{}

// GetResources200Response struct for GetResources200Response
type GetResources200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetResources200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetResources200Response) GetData() []GetResources200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetResources200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetResources200ResponseDataInner and assigns it to the Data field.
func (o *GetResources200Response) SetData(v []GetResources200ResponseDataInner) {
	o.Data = v
}

func (o GetResources200Response) MarshalJSON() ([]byte, error) {
...
func (o GetResources200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetResources200Response struct {
	value *GetResources200Response
	isSet bool
}

func (v NullableGetResources200Response) Get() *GetResources200Response {
	return v.value
}

func (v *NullableGetResources200Response) Set(val *GetResources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetResources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetResources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetResources200Response(val *GetResources200Response) *NullableGetResources200Response {
	return &NullableGetResources200Response{value: val, isSet: true}
}

func (v NullableGetResources200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetResources200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
