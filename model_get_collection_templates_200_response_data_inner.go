...
// checks if the GetCollectionTemplates200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionTemplates200ResponseDataInner{}

// GetCollectionTemplates200ResponseDataInner struct for GetCollectionTemplates200ResponseDataInner
type GetCollectionTemplates200ResponseDataInner struct {
...
func NewGetCollectionTemplates200ResponseDataInner() *GetCollectionTemplates200ResponseDataInner {
	this := GetCollectionTemplates200ResponseDataInner{}
	return &this
}
...
func (o GetCollectionTemplates200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionTemplates200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionTemplates200ResponseDataInner struct {
	value *GetCollectionTemplates200ResponseDataInner
	isSet bool
}

func (v NullableGetCollectionTemplates200ResponseDataInner) Get() *GetCollectionTemplates200ResponseDataInner {
	return v.value
}

func (v *NullableGetCollectionTemplates200ResponseDataInner) Set(val *GetCollectionTemplates200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionTemplates200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionTemplates200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionTemplates200ResponseDataInner(val *GetCollectionTemplates200ResponseDataInner) *NullableGetCollectionTemplates200ResponseDataInner {
	return &NullableGetCollectionTemplates200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetCollectionTemplates200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionTemplates200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
