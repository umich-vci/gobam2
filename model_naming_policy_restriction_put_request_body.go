...
// checks if the NamingPolicyRestrictionPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamingPolicyRestrictionPutRequestBody{}

// NamingPolicyRestrictionPutRequestBody struct for NamingPolicyRestrictionPutRequestBody
type NamingPolicyRestrictionPutRequestBody struct {
...
type _NamingPolicyRestrictionPutRequestBody NamingPolicyRestrictionPutRequestBody
...
func NewNamingPolicyRestrictionPutRequestBody(name string, restrictions []ValueMatchTypePairBean) *NamingPolicyRestrictionPutRequestBody {
	this := NamingPolicyRestrictionPutRequestBody{}
	this.Name = name
...
func (o NamingPolicyRestrictionPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o NamingPolicyRestrictionPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *NamingPolicyRestrictionPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varNamingPolicyRestrictionPutRequestBody := _NamingPolicyRestrictionPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNamingPolicyRestrictionPutRequestBody)

	if err != nil {
		return err
	}

	*o = NamingPolicyRestrictionPutRequestBody(varNamingPolicyRestrictionPutRequestBody)

	return err
}

type NullableNamingPolicyRestrictionPutRequestBody struct {
	value *NamingPolicyRestrictionPutRequestBody
	isSet bool
}

func (v NullableNamingPolicyRestrictionPutRequestBody) Get() *NamingPolicyRestrictionPutRequestBody {
	return v.value
}

func (v *NullableNamingPolicyRestrictionPutRequestBody) Set(val *NamingPolicyRestrictionPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableNamingPolicyRestrictionPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableNamingPolicyRestrictionPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamingPolicyRestrictionPutRequestBody(val *NamingPolicyRestrictionPutRequestBody) *NullableNamingPolicyRestrictionPutRequestBody {
	return &NullableNamingPolicyRestrictionPutRequestBody{value: val, isSet: true}
}

func (v NullableNamingPolicyRestrictionPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamingPolicyRestrictionPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
