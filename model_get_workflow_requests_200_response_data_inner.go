...
// checks if the GetWorkflowRequests200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWorkflowRequests200ResponseDataInner{}

// GetWorkflowRequests200ResponseDataInner struct for GetWorkflowRequests200ResponseDataInner
type GetWorkflowRequests200ResponseDataInner struct {
...
func NewGetWorkflowRequests200ResponseDataInner() *GetWorkflowRequests200ResponseDataInner {
	this := GetWorkflowRequests200ResponseDataInner{}
	return &this
}
...
func (o GetWorkflowRequests200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetWorkflowRequests200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetWorkflowRequests200ResponseDataInner struct {
	value *GetWorkflowRequests200ResponseDataInner
	isSet bool
}

func (v NullableGetWorkflowRequests200ResponseDataInner) Get() *GetWorkflowRequests200ResponseDataInner {
	return v.value
}

func (v *NullableGetWorkflowRequests200ResponseDataInner) Set(val *GetWorkflowRequests200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWorkflowRequests200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWorkflowRequests200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWorkflowRequests200ResponseDataInner(val *GetWorkflowRequests200ResponseDataInner) *NullableGetWorkflowRequests200ResponseDataInner {
	return &NullableGetWorkflowRequests200ResponseDataInner{value: val, isSet: true}
}

func (v NullableGetWorkflowRequests200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWorkflowRequests200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
