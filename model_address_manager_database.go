...
// checks if the AddressManagerDatabase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressManagerDatabase{}

// AddressManagerDatabase struct for AddressManagerDatabase
type AddressManagerDatabase struct {
...
func (o AddressManagerDatabase) MarshalJSON() ([]byte, error) {
...
func (o AddressManagerDatabase) ToMap() (map[string]interface{}, error) {
...
type NullableAddressManagerDatabase struct {
	value *AddressManagerDatabase
	isSet bool
}

func (v NullableAddressManagerDatabase) Get() *AddressManagerDatabase {
	return v.value
}

func (v *NullableAddressManagerDatabase) Set(val *AddressManagerDatabase) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressManagerDatabase) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressManagerDatabase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressManagerDatabase(val *AddressManagerDatabase) *NullableAddressManagerDatabase {
	return &NullableAddressManagerDatabase{value: val, isSet: true}
}

func (v NullableAddressManagerDatabase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressManagerDatabase) UnmarshalJSON(src []byte) error {
	v.isSet = true
