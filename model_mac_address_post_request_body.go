...
// checks if the MACAddressPostRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MACAddressPostRequestBody{}

// MACAddressPostRequestBody struct for MACAddressPostRequestBody
type MACAddressPostRequestBody struct {
...
type _MACAddressPostRequestBody MACAddressPostRequestBody
...
func NewMACAddressPostRequestBody(address string) *MACAddressPostRequestBody {
	this := MACAddressPostRequestBody{}
...
func (o MACAddressPostRequestBody) MarshalJSON() ([]byte, error) {
...
func (o MACAddressPostRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *MACAddressPostRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varMACAddressPostRequestBody := _MACAddressPostRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMACAddressPostRequestBody)

	if err != nil {
		return err
	}

	*o = MACAddressPostRequestBody(varMACAddressPostRequestBody)

	return err
}

type NullableMACAddressPostRequestBody struct {
	value *MACAddressPostRequestBody
	isSet bool
}

func (v NullableMACAddressPostRequestBody) Get() *MACAddressPostRequestBody {
	return v.value
}

func (v *NullableMACAddressPostRequestBody) Set(val *MACAddressPostRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableMACAddressPostRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableMACAddressPostRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMACAddressPostRequestBody(val *MACAddressPostRequestBody) *NullableMACAddressPostRequestBody {
	return &NullableMACAddressPostRequestBody{value: val, isSet: true}
}

func (v NullableMACAddressPostRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMACAddressPostRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
