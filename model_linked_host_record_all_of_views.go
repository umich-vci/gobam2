...
// checks if the LinkedHostRecordAllOfViews type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkedHostRecordAllOfViews{}

// LinkedHostRecordAllOfViews struct for LinkedHostRecordAllOfViews
type LinkedHostRecordAllOfViews struct {
...
type _LinkedHostRecordAllOfViews LinkedHostRecordAllOfViews
...
func NewLinkedHostRecordAllOfViews(id int64) *LinkedHostRecordAllOfViews {
	this := LinkedHostRecordAllOfViews{}
	this.Id = id
	return &this
}
...
func (o LinkedHostRecordAllOfViews) MarshalJSON() ([]byte, error) {
...
func (o LinkedHostRecordAllOfViews) ToMap() (map[string]interface{}, error) {
...
func (o *LinkedHostRecordAllOfViews) UnmarshalJSON(data []byte) (err error) {
	...
	varLinkedHostRecordAllOfViews := _LinkedHostRecordAllOfViews{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLinkedHostRecordAllOfViews)

	if err != nil {
		return err
	}

	*o = LinkedHostRecordAllOfViews(varLinkedHostRecordAllOfViews)

	return err
}

type NullableLinkedHostRecordAllOfViews struct {
	value *LinkedHostRecordAllOfViews
	isSet bool
}

func (v NullableLinkedHostRecordAllOfViews) Get() *LinkedHostRecordAllOfViews {
	return v.value
}

func (v *NullableLinkedHostRecordAllOfViews) Set(val *LinkedHostRecordAllOfViews) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkedHostRecordAllOfViews) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkedHostRecordAllOfViews) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkedHostRecordAllOfViews(val *LinkedHostRecordAllOfViews) *NullableLinkedHostRecordAllOfViews {
	return &NullableLinkedHostRecordAllOfViews{value: val, isSet: true}
}

func (v NullableLinkedHostRecordAllOfViews) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkedHostRecordAllOfViews) UnmarshalJSON(src []byte) error {
	v.isSet = true
