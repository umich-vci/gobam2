...
// checks if the GetCollectionDeploymentOptionDefinitions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectionDeploymentOptionDefinitions200Response{}

// GetCollectionDeploymentOptionDefinitions200Response struct for GetCollectionDeploymentOptionDefinitions200Response
type GetCollectionDeploymentOptionDefinitions200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetCollectionDeploymentOptionDefinitions200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetCollectionDeploymentOptionDefinitions200Response() *GetCollectionDeploymentOptionDefinitions200Response {
	this := GetCollectionDeploymentOptionDefinitions200Response{}
	return &this
}
...
func (o *GetCollectionDeploymentOptionDefinitions200Response) GetData() []GetCollectionDeploymentOptionDefinitions200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetCollectionDeploymentOptionDefinitions200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetCollectionDeploymentOptionDefinitions200ResponseDataInner and assigns it to the Data field.
...
func (o GetCollectionDeploymentOptionDefinitions200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCollectionDeploymentOptionDefinitions200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCollectionDeploymentOptionDefinitions200Response struct {
	value *GetCollectionDeploymentOptionDefinitions200Response
	isSet bool
}

func (v NullableGetCollectionDeploymentOptionDefinitions200Response) Get() *GetCollectionDeploymentOptionDefinitions200Response {
	return v.value
}

func (v *NullableGetCollectionDeploymentOptionDefinitions200Response) Set(val *GetCollectionDeploymentOptionDefinitions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCollectionDeploymentOptionDefinitions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCollectionDeploymentOptionDefinitions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCollectionDeploymentOptionDefinitions200Response(val *GetCollectionDeploymentOptionDefinitions200Response) *NullableGetCollectionDeploymentOptionDefinitions200Response {
	return &NullableGetCollectionDeploymentOptionDefinitions200Response{value: val, isSet: true}
}

func (v NullableGetCollectionDeploymentOptionDefinitions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCollectionDeploymentOptionDefinitions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
