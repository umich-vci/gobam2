...
// checks if the ServerGroupPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerGroupPutRequestBody{}

// ServerGroupPutRequestBody struct for ServerGroupPutRequestBody
type ServerGroupPutRequestBody struct {
...
func NewServerGroupPutRequestBody() *ServerGroupPutRequestBody {
	this := ServerGroupPutRequestBody{}
	return &this
}
...
func (o ServerGroupPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o ServerGroupPutRequestBody) ToMap() (map[string]interface{}, error) {
...
type NullableServerGroupPutRequestBody struct {
	value *ServerGroupPutRequestBody
	isSet bool
}

func (v NullableServerGroupPutRequestBody) Get() *ServerGroupPutRequestBody {
	return v.value
}

func (v *NullableServerGroupPutRequestBody) Set(val *ServerGroupPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableServerGroupPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableServerGroupPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerGroupPutRequestBody(val *ServerGroupPutRequestBody) *NullableServerGroupPutRequestBody {
	return &NullableServerGroupPutRequestBody{value: val, isSet: true}
}

func (v NullableServerGroupPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerGroupPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
