...
// checks if the GetResourceRecordDependentRecords200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetResourceRecordDependentRecords200Response{}

// GetResourceRecordDependentRecords200Response struct for GetResourceRecordDependentRecords200Response
type GetResourceRecordDependentRecords200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetResourceRecordDependentRecords200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetResourceRecordDependentRecords200Response() *GetResourceRecordDependentRecords200Response {
	this := GetResourceRecordDependentRecords200Response{}
	return &this
}
...
func (o *GetResourceRecordDependentRecords200Response) GetData() []GetResourceRecordDependentRecords200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetResourceRecordDependentRecords200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetResourceRecordDependentRecords200ResponseDataInner and assigns it to the Data field.
func (o *GetResourceRecordDependentRecords200Response) SetData(v []GetResourceRecordDependentRecords200ResponseDataInner) {
	o.Data = v
}

func (o GetResourceRecordDependentRecords200Response) MarshalJSON() ([]byte, error) {
...
func (o GetResourceRecordDependentRecords200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetResourceRecordDependentRecords200Response struct {
	value *GetResourceRecordDependentRecords200Response
	isSet bool
}

func (v NullableGetResourceRecordDependentRecords200Response) Get() *GetResourceRecordDependentRecords200Response {
	return v.value
}

func (v *NullableGetResourceRecordDependentRecords200Response) Set(val *GetResourceRecordDependentRecords200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetResourceRecordDependentRecords200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetResourceRecordDependentRecords200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetResourceRecordDependentRecords200Response(val *GetResourceRecordDependentRecords200Response) *NullableGetResourceRecordDependentRecords200Response {
	return &NullableGetResourceRecordDependentRecords200Response{value: val, isSet: true}
}

func (v NullableGetResourceRecordDependentRecords200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetResourceRecordDependentRecords200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
