...
// checks if the GetMerges200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMerges200Response{}

// GetMerges200Response struct for GetMerges200Response
type GetMerges200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetMerges200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetMerges200Response) GetData() []GetMerges200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetMerges200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetMerges200ResponseDataInner and assigns it to the Data field.
func (o *GetMerges200Response) SetData(v []GetMerges200ResponseDataInner) {
	o.Data = v
}

func (o GetMerges200Response) MarshalJSON() ([]byte, error) {
...
func (o GetMerges200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetMerges200Response struct {
	value *GetMerges200Response
	isSet bool
}

func (v NullableGetMerges200Response) Get() *GetMerges200Response {
	return v.value
}

func (v *NullableGetMerges200Response) Set(val *GetMerges200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMerges200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMerges200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMerges200Response(val *GetMerges200Response) *NullableGetMerges200Response {
	return &NullableGetMerges200Response{value: val, isSet: true}
}

func (v NullableGetMerges200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMerges200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
