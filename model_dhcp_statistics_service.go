...
// checks if the DHCPStatisticsService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DHCPStatisticsService{}

// DHCPStatisticsService struct for DHCPStatisticsService
type DHCPStatisticsService struct {
	Service
	// The resource type.
...
func (o DHCPStatisticsService) MarshalJSON() ([]byte, error) {
...
func (o DHCPStatisticsService) ToMap() (map[string]interface{}, error) {
...
type NullableDHCPStatisticsService struct {
	value *DHCPStatisticsService
	isSet bool
}

func (v NullableDHCPStatisticsService) Get() *DHCPStatisticsService {
	return v.value
}

func (v *NullableDHCPStatisticsService) Set(val *DHCPStatisticsService) {
	v.value = val
	v.isSet = true
}

func (v NullableDHCPStatisticsService) IsSet() bool {
	return v.isSet
}

func (v *NullableDHCPStatisticsService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDHCPStatisticsService(val *DHCPStatisticsService) *NullableDHCPStatisticsService {
	return &NullableDHCPStatisticsService{value: val, isSet: true}
}

func (v NullableDHCPStatisticsService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDHCPStatisticsService) UnmarshalJSON(src []byte) error {
	v.isSet = true
