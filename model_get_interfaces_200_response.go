...
// checks if the GetInterfaces200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetInterfaces200Response{}

// GetInterfaces200Response struct for GetInterfaces200Response
type GetInterfaces200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetInterfaces200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetInterfaces200Response) GetData() []GetInterfaces200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetInterfaces200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetInterfaces200ResponseDataInner and assigns it to the Data field.
func (o *GetInterfaces200Response) SetData(v []GetInterfaces200ResponseDataInner) {
	o.Data = v
}

func (o GetInterfaces200Response) MarshalJSON() ([]byte, error) {
...
func (o GetInterfaces200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetInterfaces200Response struct {
	value *GetInterfaces200Response
	isSet bool
}

func (v NullableGetInterfaces200Response) Get() *GetInterfaces200Response {
	return v.value
}

func (v *NullableGetInterfaces200Response) Set(val *GetInterfaces200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInterfaces200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInterfaces200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInterfaces200Response(val *GetInterfaces200Response) *NullableGetInterfaces200Response {
	return &NullableGetInterfaces200Response{value: val, isSet: true}
}

func (v NullableGetInterfaces200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInterfaces200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
