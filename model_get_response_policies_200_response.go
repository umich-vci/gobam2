...
// checks if the GetResponsePolicies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetResponsePolicies200Response{}

// GetResponsePolicies200Response struct for GetResponsePolicies200Response
type GetResponsePolicies200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetResponsePolicies200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetResponsePolicies200Response() *GetResponsePolicies200Response {
	this := GetResponsePolicies200Response{}
	return &this
}
...
func (o *GetResponsePolicies200Response) GetData() []GetResponsePolicies200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetResponsePolicies200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetResponsePolicies200ResponseDataInner and assigns it to the Data field.
func (o *GetResponsePolicies200Response) SetData(v []GetResponsePolicies200ResponseDataInner) {
	o.Data = v
}

func (o GetResponsePolicies200Response) MarshalJSON() ([]byte, error) {
...
func (o GetResponsePolicies200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetResponsePolicies200Response struct {
	value *GetResponsePolicies200Response
	isSet bool
}

func (v NullableGetResponsePolicies200Response) Get() *GetResponsePolicies200Response {
	return v.value
}

func (v *NullableGetResponsePolicies200Response) Set(val *GetResponsePolicies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetResponsePolicies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetResponsePolicies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetResponsePolicies200Response(val *GetResponsePolicies200Response) *NullableGetResponsePolicies200Response {
	return &NullableGetResponsePolicies200Response{value: val, isSet: true}
}

func (v NullableGetResponsePolicies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetResponsePolicies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
