...
// checks if the TagGroupPutRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagGroupPutRequestBody{}

// TagGroupPutRequestBody struct for TagGroupPutRequestBody
type TagGroupPutRequestBody struct {
...
type _TagGroupPutRequestBody TagGroupPutRequestBody
...
func (o TagGroupPutRequestBody) MarshalJSON() ([]byte, error) {
...
func (o TagGroupPutRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *TagGroupPutRequestBody) UnmarshalJSON(data []byte) (err error) {
	...
	varTagGroupPutRequestBody := _TagGroupPutRequestBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTagGroupPutRequestBody)

	if err != nil {
		return err
	}

	*o = TagGroupPutRequestBody(varTagGroupPutRequestBody)

	return err
}

type NullableTagGroupPutRequestBody struct {
	value *TagGroupPutRequestBody
	isSet bool
}

func (v NullableTagGroupPutRequestBody) Get() *TagGroupPutRequestBody {
	return v.value
}

func (v *NullableTagGroupPutRequestBody) Set(val *TagGroupPutRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableTagGroupPutRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableTagGroupPutRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagGroupPutRequestBody(val *TagGroupPutRequestBody) *NullableTagGroupPutRequestBody {
	return &NullableTagGroupPutRequestBody{value: val, isSet: true}
}

func (v NullableTagGroupPutRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagGroupPutRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
