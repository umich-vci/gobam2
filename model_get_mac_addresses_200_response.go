...
// checks if the GetMacAddresses200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMacAddresses200Response{}

// GetMacAddresses200Response struct for GetMacAddresses200Response
type GetMacAddresses200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetMacAddresses200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetMacAddresses200Response() *GetMacAddresses200Response {
	this := GetMacAddresses200Response{}
	return &this
}
...
func (o *GetMacAddresses200Response) GetData() []GetMacAddresses200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetMacAddresses200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetMacAddresses200ResponseDataInner and assigns it to the Data field.
func (o *GetMacAddresses200Response) SetData(v []GetMacAddresses200ResponseDataInner) {
	o.Data = v
}

func (o GetMacAddresses200Response) MarshalJSON() ([]byte, error) {
...
func (o GetMacAddresses200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetMacAddresses200Response struct {
	value *GetMacAddresses200Response
	isSet bool
}

func (v NullableGetMacAddresses200Response) Get() *GetMacAddresses200Response {
	return v.value
}

func (v *NullableGetMacAddresses200Response) Set(val *GetMacAddresses200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMacAddresses200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMacAddresses200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMacAddresses200Response(val *GetMacAddresses200Response) *NullableGetMacAddresses200Response {
	return &NullableGetMacAddresses200Response{value: val, isSet: true}
}

func (v NullableGetMacAddresses200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMacAddresses200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
