...
// checks if the GetLeases200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLeases200Response{}

// GetLeases200Response struct for GetLeases200Response
type GetLeases200Response struct {
	Links *CollectionHalLinks `json:"_links,omitempty"`
	Count *int32 `json:"count,omitempty"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	Data []GetLeases200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *GetLeases200Response) GetData() []GetLeases200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetLeases200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetLeases200ResponseDataInner and assigns it to the Data field.
func (o *GetLeases200Response) SetData(v []GetLeases200ResponseDataInner) {
	o.Data = v
}

func (o GetLeases200Response) MarshalJSON() ([]byte, error) {
...
func (o GetLeases200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetLeases200Response struct {
	value *GetLeases200Response
	isSet bool
}

func (v NullableGetLeases200Response) Get() *GetLeases200Response {
	return v.value
}

func (v *NullableGetLeases200Response) Set(val *GetLeases200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLeases200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLeases200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLeases200Response(val *GetLeases200Response) *NullableGetLeases200Response {
	return &NullableGetLeases200Response{value: val, isSet: true}
}

func (v NullableGetLeases200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLeases200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
